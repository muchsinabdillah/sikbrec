$(document).ready(function () {
    ...
    var PeriodeAkhir = document.getElementById("PeriodeAkhir").value; 
        ...
        window.location = base_url + "/SIKBREC/public/ExcelInfoPurchaseOrder/ExcelInfoPurchaseOrder2/" + PeriodeAwal + "/" + PeriodeAkhir;
...
function TrigerTgl() {
 ...
 function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/InfoPurchaseOrder/getDataListInfoPurchaseOrder",
            "dataSrc": "",
            "type": "POST",
            data: function (d) {
