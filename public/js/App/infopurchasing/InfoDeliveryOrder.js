...
var PeriodeAkhir = document.getElementById("PeriodeAkhir").value; 
    ...
    window.location = base_url + "/SIKBREC/public/ExcelInfoDeliveryOrder/ExcelInfoDeliveryOrder2/" + PeriodeAwal + "/" + PeriodeAkhir;
...
function TrigerTgl() {
 ...
 function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/InfoDeliveryOrder/getDataListInfoDeliveryOrder",
            "dataSrc": "",
            "type": "POST",
            data: function (d) {
        ...
        "columns": [
            ...
            { "data": "Last_Price" },
            { "data": "Price" },
            { "data": "Discount_Prosen" },
            { "data": "Discount_Rp" },
            { "data": "DiscountRp_TTL" },
            { "data": "Qty_Purchase" },
            { "data": "Qty_Delivery" },
            { "data": "QtyDelivery_Remain" },
            { "data": "SubtotalDelivery_Order" },          
            { "data": "Tax_Prosen" },          
            { "data": "Tax_Rp" },          
            { "data": "TaxRp_TTL" },          
            { "data": "TotalDelivery_Order" },  
            { "data": "Hpp" },         
            { "data": "Hpp_Tax" },
            { "data": "Expired_Date" },
            { "data": "NoBatch" },
            { "data": "Konversi_Qty" },
            { "data": "KonversiQty_Total" },
