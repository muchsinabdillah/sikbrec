$(document).ready(function () {
    ...
    $('#listbillingranap_arsip').DataTable( {
    } );
    ...
    $('#btn_periode_arsip').click(function () {
        ...
        getDataListBillingRanap_Arsip(tglawal,tglakhir);
    });
...
function getDataListBillingRanap_Arsip(tglawal,tglakhir) { 
    var base_url = window.location.origin;
    $('#listbillingranap_arsip').dataTable({
           "bDestroy": true
       }).fnDestroy();
       $('#listbillingranap_arsip').DataTable({
           ...
           "ajax":
           {
               "url": base_url + "/SIKBREC/public/aBillingPasien/getDataListBillingRanap_Arsip", // URL file untuk proses select datanya
               "type": "POST",
               data: function (d) {
                d.tglawal = tglawal
                d.tglakhir = tglakhir
