...
async function asyncShowMain() {
    try {
        ...
        var id = $("#IdAuto").val();
        if (id != ""){
            const dataGetGolonganbyId = await GetGolonganbyId();  
            updateUIdataGetGolonganbyID(dataGetGolonganbyId); 
        }
...
function MyBack() {
    ...
    window.location = base_url + "/SIKBREC/public/MasterGolongan/list";
}
