...
function showInputTukarFaktur(str) {
    ...
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/TukarFaktur/createmanual/' + str;
}
function showInputTukarFakturnew() {
    const base_url = window.location.origin;
    // var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/TukarFaktur/createmanual/' ;
}
...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/TukarFaktur/getFakturManualbyDateUser",
            "dataSrc": "",
            "deferRender": true,
        },
        "columns": [
