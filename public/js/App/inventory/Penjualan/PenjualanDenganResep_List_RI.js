...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/aPenjualanDenganResep/viewOrderResepbyDatePeriodeRanap",
            "type":"POST",
            "data": {
                tglawal: tglawal,
                tglakhir: tglakhir
...
function showdatatabelArsip() {
    ...
    $('#tbl_arsip').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/aPenjualanDenganResep/getSalesbyPeriodeResepRanap",
            "type":"POST",
            "data": {
                tglawal: tglawal,
                tglakhir: tglakhir
        ...
        "columns": [
            ...
            // },
            {
                "render": function (data, type, row) {
                    var html = ""
                    var html = '<button type="button" class="btn-maroon btn-xs"  onclick=showPenjualanBarangDenganResepView("' + row.NoResep + '","' + row.TransactionCode + '") >View</button>'
                    return html
                },
            },
        ]
