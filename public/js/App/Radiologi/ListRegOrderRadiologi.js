        ...
        "columns": [ 
            ...
            { "data": "namauser" }, 
            {
                "render": function (data, type, row) {
                    var html = ""
                    var html = '<button type="button" class="btn btn-default border-primary btn-animated btn-xs"  onclick=\'showFormOrderRad("' +  row.NoRegistrasi + '")\' ><span class="visible-content" > New Order</span><span class="hidden-content"><i class="fa fa-hand-pointer-o"></i></span></button>'
                    return html
                }
            },
...
function showFormOrderRad(NoRegistrasi) {
    const base_url = window.location.origin;
    var str = btoa(NoRegistrasi);
    url = base_url + '/SIKBREC/public/aRegistrasiRajal/OrderRadiologi/' + str;
