...
function getDatabyID() {
    ...
    let url = base_url + '/SIKBREC/public/MasterDataTarif/getTarifRanapbyID/';
    return fetch(url, {
        method: 'POST',
        headers: {
...
function saveTrs() {
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/MasterDataTarif/saveTrs_Ranap/';
...
function getListDataOrderDetails() { 
    ...
    $('#datalayanan').dataTable({
       ...
       $('#datalayanan').DataTable({
         'ajax':
    {
        "url": base_url + "/SIKBREC/public/MasterDataTarif/getListTarifRanap_Layanan", // URL file untuk proses select datanya
        "type": "POST",
        data: function (d) {
         d.IdAuto = IdAuto
...
function getListDataHistori() { 
    ...
    $('#datahistori').dataTable({
       ...
       $('#datahistori').DataTable({
         'ajax':
    {
        "url": base_url + "/SIKBREC/public/MasterDataTarif/getListTarifRanap_Histori", // URL file untuk proses select datanya
        "type": "POST",
        data: function (d) {
         d.IdAuto = IdAuto
         d.kd_instalasi = kd_instalasi
