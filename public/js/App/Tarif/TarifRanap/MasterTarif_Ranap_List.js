...
function showDataGroupShift(str) {
    ...
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewranap/' + str;
}
function goGroupShiftPages() {
    const base_url = window.location.origin;
    window.location = base_url + "/SIKBREC/public/MasterDataTarif/viewranap/";
}
...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/MasterDataTarif/getListDataTarifRanap",
            "dataSrc": "",
            "deferRender": true,
        },
        "columns": [
