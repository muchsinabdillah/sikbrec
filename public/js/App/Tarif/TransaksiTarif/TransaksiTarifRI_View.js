...
function getDatabyID() {
    ...
    let url = base_url + '/SIKBREC/public/MasterDataTarif/getTransaksiTarifbyIDRI/';
    return fetch(url, {
        method: 'POST',
        headers: {
...
function saveTrs() {
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/MasterDataTarif/saveTrs_TarifRI/';
...
function getBatalTrs(alasan) {
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/MasterDataTarif/BatalTransaksiTarifRI/"';
    return fetch(url, {
        method: 'POST',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
...
function MyBack() {
    ...
    window.location = base_url + "/SIKBREC/public/MasterDataTarif/listtransaksitarifri";
}
