...
function saveTrs() {
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/MasterDataTarif/saveTrs_Tariflab/';
...
function getBatalTrs(alasan) {
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/MasterDataTarif/BatalTransaksiTariflab/"';
    return fetch(url, {
        method: 'POST',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
...
function MyBack() {
    ...
    window.location = base_url + "/SIKBREC/public/MasterDataTarif/listtransaksitariflab";
}
