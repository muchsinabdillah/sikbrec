...
function showDataGroupShift(str) {
    ...
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewtransaksitarifrad/' + str;
}

function viewtransaksitarifdetail(str) {
    const base_url = window.location.origin;
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewtransaksitarifdetailrad/' + str;
}
...
function goGroupShiftPages() {
    const base_url = window.location.origin;
    window.location = base_url + "/SIKBREC/public/MasterDataTarif/viewtransaksitarifrad/";
}
...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/MasterDataTarif/getListDataTransaksiTarifRad",
            "dataSrc": "",
            "deferRender": true,
        },
        "columns": [
