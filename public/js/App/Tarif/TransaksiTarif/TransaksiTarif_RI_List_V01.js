...
function showDataGroupShift(str) {
    ...
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewtransaksitarifri/' + str;
}

function viewtransaksitarifdetail(str) {
    const base_url = window.location.origin;
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewtransaksitarifdetailri/' + str;
}
...
function goGroupShiftPages() {
    const base_url = window.location.origin;
    window.location = base_url + "/SIKBREC/public/MasterDataTarif/viewtransaksitarifri/";
}
...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/MasterDataTarif/getListDataTransaksiTarifRI",
            "dataSrc": "",
            "deferRender": true,
        },
        "columns": [
