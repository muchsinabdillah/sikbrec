...
function getListDataOrderDetails() { 
    ...
    $('#datadetail').dataTable({
       ...
       $('#datadetail').DataTable({
         'ajax':
    {
        "url": base_url + "/SIKBREC/public/MasterDataTarif/getListTransaksiTarif_Detailrad", // URL file untuk proses select datanya
        "type": "POST",
        data: function (d) {
         d.IdAuto = IdAuto
     },
...
function getDatabyID() {
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/MasterDataTarif/getTransaksiTarifbyIDrad/';
    return fetch(url, {
        method: 'POST',
        headers: {
