...
function showDataGroupShift(str) {
    ...
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewtransaksitariflab/' + str;
}

function viewtransaksitarifdetail(str) {
    const base_url = window.location.origin;
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataTarif/viewtransaksitarifdetaillab/' + str;
}
...
function goGroupShiftPages() {
    const base_url = window.location.origin;
    window.location = base_url + "/SIKBREC/public/MasterDataTarif/viewtransaksitariflab/";
}
...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/MasterDataTarif/getListDataTransaksiTarifLab",
            "dataSrc": "",
            "deferRender": true,
        },
        "columns": [
