...
async function savePengajuanSEP() {
    try {
        $(".preloader").fadeIn();
        const datagosaveApprovalPengajuanSEP = await gosaveApprovalPengajuanSEP();
        console.log("datagosaveApprovalPengajuanSEP", datagosaveApprovalPengajuanSEP)
...
function gosaveApprovalPengajuanSEP() {
    ...
    let url = base_url + '/SIKBREC/public/xBPJSBridging/gosaveApprovalPengajuanSEP';
    return fetch(url, {
        method: 'POST',
        headers: {
