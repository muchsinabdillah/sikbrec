...
function go_save() {
    ...
    $.ajax({
        url: base_url + '/pms_gut/public/Department/addDepartment',
        data: form_data,
        method: 'post',
        dataType: 'json',
        beforeSend: function () {
...
function ShowData() {
    const base_url = window.location.origin;
    var idx = $("#IdDepartment").val();
    if (idx != '' || idx != null || idx != undefined) {
        $.ajax({
            url: base_url + "/pms_gut/public/Department/getDepartmentId/",
            type: "POST",
            data: { id: idx },
            dataType: "JSON",
            success: function (data) {
                $("#IdDepartment").val(convertEntities(data.Id_Departemen));
                $("#NamaDepartment").val(convertEntities(data.Departemen));
                $('#StatusDepartment').val(data.STATUS).trigger('change');
            }, error: function (data) {
                // Welcome notification
                toastr.options = {
                    "closeButton": true,
...
function MyBack() {
    const base_url = window.location.origin;
    window.location = base_url + "/pms_gut/public/Department";
}
