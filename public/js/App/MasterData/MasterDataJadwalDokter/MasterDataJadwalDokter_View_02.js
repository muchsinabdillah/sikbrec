$(document).ready(function () {
 ...
 function updateUIdatagetDokterAllAktif(datagetDokterAllAktif){
     ...
     $('#Close_Schedule_Senin').val(convertEntities(responseApi.data.Close_Schedule_Senin));
     $('#Close_Schedule_Selasa').val(convertEntities(responseApi.data.Close_Schedule_Selasa));
     $('#Close_Schedule_Rabu').val(convertEntities(responseApi.data.Close_Schedule_Rabu));
     $('#Close_Schedule_Kamis').val(convertEntities(responseApi.data.Close_Schedule_Kamis));
     $('#Close_Schedule_Jumat').val(convertEntities(responseApi.data.Close_Schedule_Jumat));
     $('#Close_Schedule_Sabtu').val(convertEntities(responseApi.data.Close_Schedule_Sabtu));
     $('#Close_Schedule_Minggu').val(convertEntities(responseApi.data.Close_Schedule_Minggu));
     
     $('#Open_Jadwal_Senin').val(convertEntities(responseApi.data.Open_Assesment_Senin));
     $('#Open_Jadwal_Selasa').val(convertEntities(responseApi.data.Open_Assesment_Selasa));
     $('#Open_Jadwal_Rabu').val(convertEntities(responseApi.data.Open_Assesment_Rabu));
     $('#Open_Jadwal_Kamis').val(convertEntities(responseApi.data.Open_Assesment_Kamis));
     $('#Open_Jadwal_Jumat').val(convertEntities(responseApi.data.Open_Assesment_Jumat));
     $('#Open_Jadwal_Sabtu').val(convertEntities(responseApi.data.Open_Assesment_Sabtu));
     $('#Open_Jadwal_Minggu').val(convertEntities(responseApi.data.Open_Assesment_Minggu));
