$(document).ready(function () {
    // let Pelatihan_Dokter;
    // let Pendidikan_Dokter;
    // let Description_Dokter;
    
  
    // ClassicEditor
    // .create( document.querySelector( '#Pendidikan_Dokter' ) )
    // .then( newEditor => {
    //     Pendidikan_Dokter = newEditor;
    // } )
    // .catch( error => {
    //     console.error( error );
    // } );
    ...
    // ClassicEditor
    // .create( document.querySelector( '#Pelatihan_Dokter' ) )
    // .then( newEditor => {
    //     Pelatihan_Dokter = newEditor;
    // } )
    // .catch( error => {
    //     console.error( error );
    // } );
    ...
    // ClassicEditor
    // .create( document.querySelector( '#Description_Dokter' ) )
    // .then( newEditor => {
    //     Description_Dokter = newEditor;
    // } )
    // .catch( error => {
    //     console.error( error );
    // } );
    ...
    $('#form_cuti').submit(
        function (e) {
            ...
            form_data.append("Pendidikan_Dokter",Pendidikan_Dokter.getData());
            form_data.append("Description_Dokter",Description_Dokter.getData());
            form_data.append("Pelatihan_Dokter",Pelatihan_Dokter.getData());  
            $.ajax({
                url: base_url + '/SIKBREC/public/MasterDataDokter/Savewithout_Image_Dokter/',
                type: 'POST',
                data: form_data,
                processData: false,
                contentType: false,
...
function updateUIdatagetDataDokterbyId(datagetDataDokterbyId) {
    ...
    Pelatihan_Dokter.setData(convertEntities(dataResponse.data.Pelatihan));
    Pendidikan_Dokter.setData(convertEntities(dataResponse.data.Pendidikan));
    Description_Dokter.setData(convertEntities(dataResponse.data.Description));

    // $("#Pendidikan_Dokter").val(convertEntities(dataResponse.data.Pendidikan));
     
    
    // $("#Description_Dokter").val(convertEntities(dataResponse.data.Description));
    // $("#Pelatihan_Dokter").val(convertEntities(dataResponse.data.Pelatihan));
...
//  function send_1() {
//   var testing = "<p><strong>Tiltexxxxxxxxxxxxxxxxxxxxx</strong></p><p><i>123</i></p>";
//   Pendidikan_Dokter.setData(testing);
// }