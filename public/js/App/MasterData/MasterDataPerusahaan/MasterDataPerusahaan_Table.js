...
function showDataGroupShift(str) {
    ...
    var str = btoa(str);
    window.location = base_url + '/SIKBREC/public/MasterDataPerusahaan/viewPerusahaan/' + str;
}
function goGroupShiftPages() {
    const base_url = window.location.origin;
    window.location = base_url + "/SIKBREC/public/MasterDataPerusahaan/viewPerusahaan/";
}
...
function showdatatabel() {
    ...
    $('#example').DataTable({
        "ordering": true,
        "ajax": {
            "url": base_url + "/SIKBREC/public/MasterDataPerusahaan/getAllDataPerusahaan",
            "dataSrc": "",
            "deferRender": true,
        },
        "columns": [
