...
tandatangan.addEventListener('click',function (e) {
    swal({
        title: "Simpan & Simpan",
        text: "Apakah Anda Yakin Ingin Simpan & Simpan ?",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
    ...
    $.ajax({
        url: base_url + '/SIKBREC/public/signatureDigital/saveTataTertib',
        data: FormData,
        type: 'post',
        dataType: 'json',
        success: function(response) {
...
async function gouploadtoAws(data,email) {
    try {
        //await uploadtoAws(data);
        const awsurl = await uploadtoAws_filepdf(data);
        await goSendMail(email,awsurl);
...
async function uploadtoAws(param){
    var FormData = {
        namaparam1:nama.value,
        namaparam2:nama.value,
        uuid1:param1,
    ...
    $.ajax({
        url: base_url + '/SIKBREC/public/signatureDigital/uploadToAwsSignTataTertib',
        data: FormData,
        type: 'post',
        dataType: 'json',
        success: function(response) {
...
// async function uploadtoAws_filepdf(param){
//     var FormData = {
//         id:param,
//     }
//     $.ajax({
//         url: base_url + '/SIKBREC/public/aRegistrasiRajal/SaveTataTertib',
//         data: FormData,
//         type: 'post',
//         dataType: 'json',
//         success: function(response) {
...
async function uploadtoAws_filepdf(param){
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/aRegistrasiRajal/SaveTataTertib';
    return fetch(url, {
    method: 'POST',
    headers: {
...
function validateEmail(email) {
  ...
  async function goSendMail (email_send,aws_url){
    var aws_url = aws_url['aws_url'];
    var param = $("#xnoMedrec").val();
    $(".preloader").fadeIn();
    var base_url = window.location.origin;
    const url = base_url + "/SIKBREC/public/aRegistrasiRajal/SendMailSaveTataTertib/";
              $.ajax({
                  url: url,
                  type: "POST",
