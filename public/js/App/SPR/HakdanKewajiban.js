...
tandatangan.addEventListener('click',function (e) {
    ...
    if (!validateEmail(email_send)) {
       ...
       $.ajax({
           url: base_url + '/SIKBREC/public/signatureDigital/saveHakdanKewajiban',
           data: FormData,
           type: 'post',
           dataType: 'json',
           success: function(response) {
...
async function uploadtoAwsx(param){
    ...
    $.ajax({
        url: base_url + '/SIKBREC/public/signatureDigital/uploadToAwsSignHakKewajiban',
        data: FormData,
        type: 'post',
        dataType: 'json',
        success: function(response) {
...
//     }
//     $.ajax({
//         url: base_url + '/SIKBREC/public/aRegistrasiRajal/SaveHakdanKewajiban',
//         data: FormData,
//         type: 'post',
//         dataType: 'json',
//         success: function(response) {
...
async function uploadtoAws_filepdfx(param){
    ...
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/aRegistrasiRajal/SaveHakdanKewajiban';
    return fetch(url, {
    method: 'POST',
    headers: {
...
function validateEmail(email) {
 ...
 async function goSendMailx (email_send,aws_url){
    ...
    $(".preloader").fadeIn();
    var base_url = window.location.origin;
    const url = base_url + "/SIKBREC/public/aRegistrasiRajal/SendHakdanKewajiban/";
              $.ajax({
                  url: url,
                  type: "POST",
