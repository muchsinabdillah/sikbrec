...
$(document).ready(function () {  
    ...
    $('#formUploadManual').submit(
        function (e) {
            ...
            form_data.append("jenisPelatihan", $("#jenisPelatihan").val()); 
            form_data.append("namaPelatihan", $("#namaPelatihan").val()); 
            form_data.append("tglAwalPelatihan", $("#tglAwalPelatihan").val());
            form_data.append("tglAkhirPelatihan", $("#tglAkhirPelatihan").val());
            form_data.append("noSertif", $("#noSertif").val());
            form_data.append("lamaPelatihan", $("#lamaPelatihan").val());
            form_data.append("address", $("#address").val());
            form_data.append("jenisdoc", $("#jenisdoc").val()); 
            $.ajax({
                url: base_url + '/SIKBREC/public/FormDataPegawai/uploadDataPelatihan/',
                type: 'POST',
                data: form_data,
                processData: false,
                contentType: false,
...
function updateUGetDataPegawaiById2(data){
    ...
    $("#jenisPelatihan").val(data.Jenis_Pelatihan);
    $("#namaPelatihan").val(data.Nama_Pelatihan);
    $("#tglAwalPelatihan").val(data.Tgl_Awal); 
    $("#tglAkhirPelatihan").val(data.Tgl_Akhir);
    $("#noSertif").val(data.No_Sertifikat);
    $("#lamaPelatihan").val(data.Lama_Pelatihan_Internal);
    $("#jenisdoc").val(data.JenisDocument);
    $("#address").val(data.Alamat_Pelatihan);
...
function GetDataPegawaiById2() {
    ...
    let url = base_url + '/SIKBREC/public/FormDataPegawai/getDataPelatihanDetail';
    return fetch(url, {
        method: 'POST',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
...
function LoadData() {
    ...
    $('#example').DataTable({
        ...
        //"order": [[ 2, "desc" ]],s
        "ajax": {
            "url": base_url + '/SIKBREC/public/FormDataPegawai/getDataListPelatihan',
            "dataSrc": "",
            "deferRender": true,
            "type": "POST",
            data: function (d) {
...
function showDataGroupShift(str) {
    const base_url = window.location.origin;
    window.location = base_url + '/SIKBREC/public/FormDataPegawai/UpdateDataPelatihan/' + str;
