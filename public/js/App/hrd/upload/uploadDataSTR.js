$(document).ready(function () {  
    ...
    $('#formUploadManual').submit(
        function (e) {
            ...
            form_data.append("tglAwalSTR", $("#tglAwalSTR").val()); 
            form_data.append("tglAkhirSTR", $("#tglAkhirSTR").val()); 
            form_data.append("noSuratSTR", $("#noSuratSTR").val()); 
            form_data.append("jenisdoc", $("#jenisdoc").val()); 
            $.ajax({
                url: base_url + '/SIKBREC/public/FormDataPegawai/uploadDataSTR/',
                type: 'POST',
                data: form_data,
                processData: false,
                contentType: false,
...
function updateUGetDataPegawaiById2(data){
    ...
    $("#tglAwalSTR").val(data.Tgl_Awal); 
    $("#tglAkhirSTR").val(data.Tgl_Akhir);
    $("#noSuratSTR").val(data.No_STR);
...
function GetDataPegawaiById2() {
    ...
    let url = base_url + '/SIKBREC/public/FormDataPegawai/getDataSTRDetail';
    return fetch(url, {
        method: 'POST',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
...
function LoadData() {
    ...
    $('#example').DataTable({
        ...
        //"order": [[ 2, "desc" ]],s
        "ajax": {
            "url": base_url + '/SIKBREC/public/FormDataPegawai/getDataListSTR',
            "dataSrc": "",
            "deferRender": true,
            "type": "POST",
            data: function (d) {
...
function showDataGroupShift(str) {
    const base_url = window.location.origin;
    window.location = base_url + '/SIKBREC/public/FormDataPegawai/UpdateDataSTR/' + str;
