...
function getPoli() {
    ...
    let url = base_url + '/SIKBREC/public/bInfo_ICDX/getListPoli';
    return fetch(url, {
        method: 'POST',
        headers: {
...
function getDokter() {
    var base_url = window.location.origin;
    let url = base_url + '/SIKBREC/public/bInfo_ICDX/getDokter';
    return fetch(url, {
        method: 'POST',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
...
function getDataRekap() { 
    ...
    if (jenisinfo == '1' ){
       ...
       $('#datatable1').DataTable({
           ...
           "ajax":
           {
               "url": base_url + "/SIKBREC/public/bInfo_ICDX/getDataRekap", // URL file untuk proses select datanya
               "type": "POST",
               data: function ( d ) {
