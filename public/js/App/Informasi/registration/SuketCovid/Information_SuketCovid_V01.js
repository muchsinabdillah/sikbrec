...
function getDataListPasien() { 
    ...
    $('#datatable').dataTable({
       ...
       $('#datatable').DataTable({
           ...
           "ajax":
           {
               "url": base_url + "/SIKBREC/public/bInformationSuketCovid/getDataListSuketCovidPasien", // URL file untuk proses select datanya
               "type": "POST",
               data: function ( d ) {
            ...
            { "data": "NoRegistrasi" }, 
              { "render": function ( data, type, row ) { // Tampilkan kolom aksi
                  var html = ""
                    ...
                    var html  = row.TglKunjungan+' '+row.jamkunjungan;
                       return html 
                }
            },   
            { "data": "UserInput" },  
