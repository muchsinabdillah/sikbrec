$(document).ready(function () {
    $(".preloader").fadeOut(); 
    $('#btnLoadInformation').attr('enable', true);
...
function excelLanscape() {
    ...
    var PeriodeAkhir = document.getElementById("PeriodeAkhir").value;
        ...
        window.location = base_url + "/SIKBREC/public/ExcelInfoWaktuTungguPoli/ExcelInfoWaktuTungguPoli2/" + PeriodeAwal + "/" + PeriodeAkhir;
...
function getDataListLmaPasien() { 
    ...
    $('#permintaanrawat_all').dataTable({
       ...
       $('#permintaanrawat_all').DataTable({
           ...
           "ajax":
           {
               "url": base_url + "/SIKBREC/public/bInformasiWaktuTUnggu/getDataListPasien_Poliklinik", // URL file untuk proses select datanya
               "type": "POST",
               data: function ( d ) {
           ...
           "columns": [
               ...
               { "data": "JenisPasien" }, // Tampilkan alamat
               { "data": "NoRegistrasi" },  // Tampilkan nama
               { "data": "PatientName" },  // Tampilkan nama 
               { "data": "NamaUnit" },  // Tampilkan nama
               { "data": "NamaDokter" },  // Tampilkan nama 
               { "data": "JenisJaminan" },  // Tampilkan nama
               { "data": "NamaJaminan" },  // Tampilkan nama 
               { "data": "NamaCaraMasuk" },  // Tampilkan nama
               { "data": "TglDaftar" },  // Tampilkan nama 
               { "data": "JamDaftar" },  // Tampilkan nama
               { "data": "TglAssesmentPerawat" },  // Tampilkan nama 
               { "data": "JamAssesmentPerawat" },  // Tampilkan nama
               { "data": "TglAssesmentDokter" },  // Tampilkan nama 
               { "data": "JamAssesmentDokter" },  // Tampilkan nama
           ],
           dom: 'Bfrtip',
            buttons: [
                'copyHtml5',
