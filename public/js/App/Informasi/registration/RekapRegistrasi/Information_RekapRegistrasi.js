...
function excelLanscape() {
    ...
    if (JenisRekap == '3') {
        ...
        window.location = base_url + "/SIKBREC/public/ExcelInfoRekapRegist/ExcelInfoRekapRegist4/" + Periode + "/" + JenisPasien + "/" + JenisRekap ;
    }
    else if (JenisRekap == '2'){
        window.location = base_url + "/SIKBREC/public/ExcelInfoRekapRegist/ExcelInfoRekapRegist3/" + Periode + "/" + JenisPasien + "/" + JenisRekap ;

} else if (JenisRekap == '4') {
    window.location = base_url + "/SIKBREC/public/ExcelInfoRekapRegist/ExcelInfoRekapRegist5/" + Periode + "/" + JenisPasien + "/" + JenisRekap ;
} else if (JenisRekap == '6') {
    window.location = base_url + "/SIKBREC/public/ExcelInfoRekapRegist/ExcelInfoRekapRegist6/" + Periode + "/" + JenisPasien + "/" + JenisRekap ;
}else if (JenisRekap == '7') {
    window.location = base_url + "/SIKBREC/public/ExcelInfoRekapRegist/ExcelInfoRekapRegist6/" + Periode + "/" + JenisPasien + "/" + JenisRekap ;
}else{
    window.location = base_url + "/SIKBREC/public/ExcelInfoRekapRegist/ExcelInfoRekapRegist2/" + Periode + "/" + JenisPasien + "/" + JenisRekap ;
}
}
function clearVal(){
    $("#JenisTipe").val('');
    ...
    JenisRekap = $("#JenisRekap").val();
        ...
        if (JenisRekap == '3') {
            ...
            $('#datatable_Rujukan').DataTable({
                ...
                "ajax":
                {
                    "url": base_url + "/SIKBREC/public/bInformationRekapRegistrasi/getDataListRekap", // URL file untuk proses select datanya
                    "type": "POST",
                    data: function ( d ) {
                    d.Periode = Periode;
        ...
        $('#datatable_unit').DataTable({
            ...
            $('#datatable_unit_only').DataTable({
                ...
                "ajax":
                {
                    "url": base_url + "/SIKBREC/public/bInformationRekapRegistrasi/getDataListRekapOnlyUnit", // URL file untuk proses select datanya
                    "type": "POST",
                    data: function (d) {
                        d.Periode = Periode;
                        d.JenisPasien = JenisPasien;
