...
function excelLanscape() {
    ...
    var PeriodeAkhir = document.getElementById("PeriodeAkhir").value;
        ...
        window.location = base_url + "/SIKBREC/public/ExcelInfoPelunasanHutangDetail/ExcelInfoPelunasanHutangDetail2/" + PeriodeAwal + "/" + PeriodeAkhir;
    ...
    var base_url = window.location.origin;
        ...
        $('#table-load-data').dataTable({
          ...
          $('#table-load-data').DataTable({
             ...
             "ajax": {
              "url": "/SIKBREC/public/Hutang/getInfoPelunasanHutangDetail",
              "type": "POST",
                  data: function ( d ) { 
          ...
          "columns": [
            ...
            { "render": function ( data, type, row ) { // Tampilkan kolom aksi 
              ...
              { "data": "NILAI_PAY" ,  render: $.fn.dataTable.render.number( ',', '.', 2,'Rp ' )},  // Tampilkan nama 
              { "data": "SISA_HUTANG" ,  render: $.fn.dataTable.render.number( ',', '.', 2,'Rp ' )},  // Tampilkan nama 
