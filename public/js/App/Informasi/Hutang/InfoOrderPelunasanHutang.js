...
function excelLanscape() {
    ...
    var PeriodeAkhir = document.getElementById("PeriodeAkhir").value;
        ...
        window.location = base_url + "/SIKBREC/public/ExcelInfoOrderPelunasanHutang/ExcelInfoOrderPelunasanHutang2/" + PeriodeAwal + "/" + PeriodeAkhir;
    ...
    var base_url = window.location.origin;
        ...
        $('#table-load-data').dataTable({
          ...
          $('#table-load-data').DataTable({
             ...
             "ajax": {
              "url": "/SIKBREC/public/Hutang/getInfoOrderPelunasanHutang",
              "type": "POST",
                  data: function ( d ) { 
          ...
          "columns": [
            ...
            //   { "render": function ( data, type, row ) { // Tampilkan kolom aksi 
            //     var html = ""
            //     var html  = '<font size="2">'+row.KD_REKANAN+' </font>';
            //     return html 
            //     }
            //   },  
              { "render": function ( data, type, row ) { // Tampilkan kolom aksi 
              ...
              { "data": "NILAI_HUTANG" ,  render: $.fn.dataTable.render.number( ',', '.', 2,'Rp ' )},  // Tampilkan nama 
        ],
