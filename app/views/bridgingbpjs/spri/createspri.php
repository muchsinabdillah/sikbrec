                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                  ...
                                  <div class="form-group  ">
                                      ...
                                      <div class="col-sm-4">
                                          <input class="form-control input-sm" maxlength="15" readonly autocomplete="off" type="text" id="SPRI_NoSPR2" name="SPRI_NoSPR2" value="<?= $data['id'] ?>">
                                          <input class="form-control input-sm" maxlength="15" readonly autocomplete="off" type="text" id="SPRI_NoSPR2BPJS" name="SPRI_NoSPR2BPJS">
                                      </div>
  ...
  <script src="<?= BASEURL; ?>/js/App/bridgingbpjs/spri/input/spri_V04.js"></script>