                      ...
                      <div class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                  ...
                                  <div class="form-group gut ">
                                      <label for="inputEmail3" class="col-sm-3 control-label"> Status <sup
                                              class="color-danger">*</sup></label>
                                      <div class="col-sm-2">
                                          <select id="MJenisStatusPelayananBPJS" nama="MJenisStatusPelayananBPJS"
                                              class="form-control input-sm">
                                              <option value="">-- PILIH --</option>
                                      ...
                                      <table id="tbl_kunjungan_monitoring" width="100%" class="table table-striped table-hover cell-border"> -->
                                              <thead>
                                                  <tr>
                                                      ...
                                                      <th align='center'>
                                                          <font size="1">Biaya Pengajuan
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Biaya Disetujui
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Tarif Grouper
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Tarif RS
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Tarif Topup
                                                      </th>
                                                  </tr>
                                              </thead>
                                              <tbody>
  ...
  <script src="<?= BASEURL; ?>/js/App/bridgingbpjs/monitoring/listMonitoringDataKlaimBPJS_v01.js"></script>