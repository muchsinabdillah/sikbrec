                          ...
                          <div class="panel-body">
                              ...
                              <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                  <div class="form-group gut ">
                                      <label for="inputEmail3" class="col-sm-3 control-label"> No. SEP <sup
                                              class="color-danger">*</sup></label>
                                      <div class="col-sm-6">
                                          <input class="form-control input-sm" type="text" maxlength="20"
                                              id="MSepInternalNoSep" autocomplete="off" name="MSepInternalNoSep"
                                              placeholder="Masukan No. SEP Induk">
                                      </div>
                                  </div>
                                          ...
                                          <table id="tbl_kunjungan_monitoring" class="display" width="100%"
                                              ...
                                              <thead>
                                                  <tr>
                                                      ...
                                                      <th align='center'>
                                                          <font size="1">No SEP Reff
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Tujuan Poli Rujuk
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Poli Asal
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Tgl Rujukan Internal
                                                      </th>
  ...
  <script src="<?= BASEURL; ?>/js/App/bridgingbpjs/monitoring/listMonitoringDataSEPInternal_v01.js"></script>