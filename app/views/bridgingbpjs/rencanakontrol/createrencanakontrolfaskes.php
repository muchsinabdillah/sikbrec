        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form_kepesertaan_Bpjs">
                    ...
                    <!--<div class="form-group gut ">
                        <label for="inputEmail3" class="col-sm-3 control-label"> Jenis SEP <sup class="color-danger">*</sup></label>
                        <div class="col-sm-6">
                            <select id="isJenisPelayananBPJS" name="isJenisPelayananBPJS" style="width: 100%;" class="form-control ">
                                <option value="">-- PILIH --</option>
                                <option value="1">Kunjungan SEP Induk</option>
                                <option value="2">Kunjungan SEP Internal</option>
                            </select>
                        </div>
                    </div>-->
...
<script src="<?= BASEURL; ?>/js/APP/bridgingbpjs/rencanakontrol/createrencanakontrolfaskes_v02.js"></script>
