                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="frmsimpanrujukan">
                                <h5 class="underline mt-30">Data SIMRS <small>( - <sup class="color-danger">*</sup>) Harus diisi </small></h5>
                                <div class="form-group tglrujukan gut">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control input-sm" readonly type="text" id="SIMRS_ID" name="SIMRS_ID">
                                    </div>
                                ...
                                <div class="form-group gut">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control input-sm" readonly type="text" id="SIMRS_RoomPoliAkhir" name="SIMRS_RoomPoliAkhir">
                                    </div>
                                ...
                                <div class="form-group datainsertrujukan gut">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control input-sm" readonly type="text" id="BPJS_NoRencKontrol" name="BPJS_NoRencKontrol" placeholder="Masukkan nomor Rencana Kontrol disini" value="<?= $data['id'] ?>">
                                    </div>
                                    <label for="tglRencanaKunjungan" class="col-sm-2 control-label"> Tgl Rencana <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-2">
                                        <input type="date" readonly id="SIMRS_TglKontrol" name="SIMRS_TglKontrol" class="form-control input-sm">
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group gut">
                                    ...
                                    <div class="col-sm-6" style="margin-left: -20px;">
                                        <input readonly class="form-control input-sm" type="text" value="Bedah" id="NamaPoliklinikBPJS" name="NamaPoliklinikBPJS">
                                    </div>
                                </div>
                                <div class="form-group gut">
                            ...
                            <div class="form-group keterangan gut">
                                <div class="col-sm-6 mt-30">
                                    ...
                                    <div class="btn-group" role="group">
                                        <button class="btn btn-warning  btn-rounded " id="batal" name="batal" href="#notif_Cetak" data-toggle='modal'>
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"> Batal/Hapus Rencana Kontrol</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="form_kepesertaan_Bpjs">
                    <h5 class="underline mt-30">Data Rencana Kontrol</h5>
...
<script src="<?= BASEURL; ?>/js/APP/bridgingbpjs/rencanakontrol/updaterencanakontrolfaskes_v01.js"></script>
