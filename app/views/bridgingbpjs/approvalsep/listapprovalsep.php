                          ...
                          <div class="panel-heading">
                              <div class="panel-title">
                                  <h5 class="underline mt-30"><?= $data['judul'] ?><small></small><a
                                          ...
                                          <span class="glyphicon glyphicon glyphicon-plus"></span> Create Approval</a>
      ...
      <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title"> Form Entri Approval SEP</h4>
              </div>
  ...
  <script src="<?= BASEURL; ?>/js/App/bridgingbpjs/approvalsep/approval/approvalpengajuansep_v01.js"></script>