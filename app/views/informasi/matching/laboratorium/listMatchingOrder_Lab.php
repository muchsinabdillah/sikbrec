                ...
                <div class="form-horizontal">
                    <div class="form-group form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" class="form-control" name="IDLab" id="IDLab" readonly>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" class="form-control" name="DateLab" id="DateLab" readonly>
                            </div>
                        </div>
...
<script src="<?= BASEURL; ?>/js/App/Matching/Laboratorium/listMatchingOrderLaboratorium.js"></script>