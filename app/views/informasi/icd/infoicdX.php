                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group gut">
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Jenis
                                                    Info</label>
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single" id="jenisinfo" name="jenisinfo" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;" onchange="clearVal(this.value)">
                                                        <option value=""></option>
                                                        <option value="1">REKAP TOTAL ICD</option>
                                                        <option value="2">REKAP TOTAL POLIKLINIK</option>
                                                        <option value="3">REKAP TOTAL DOKTER</option>
                                                        <option value="4">DETAIL ICD</option>
                                                ...
                                                <label for="inputEmail3" class="col-sm-1 control-label">
                                                    Poliklinik</label>
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single" id="Poli" name="Poli" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;">
                                                        <option value="">-- Pilih Poliklinik --</option>
                                                        <option value="1"> Pilih Semua</option>
                                            ...
                                            <div class="form-group gut">
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Nama
                                                    Dokter</label>
                                                <div class="col-sm-2">
                                                    <select class="form-control js-example-basic-single" id="Dokter" name="Dokter" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;">
                                            ...
                                            <a type="button" class="btn btn-success btn-animated btn-wide" id="btn_infoICD" name="btn_infoICD"><span class="visible-content">Load</span><span class="hidden-content"><i class="fa fa-gear"></i></span></a>
                                                    ...
                                                    <table id="datatable4" class="display" width="100%" style="display: none">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th align='center'>User Entry</th>
                                                                <th align='center'>ICD Code</th>
                                                                <th align='center'>DESCRIPTION</th>
                                                                <th align='center'>Waktu Input</th>
...
<script src="<?= BASEURL; ?>/js/App/informasi/ICD/Info_icdX.js"></script>