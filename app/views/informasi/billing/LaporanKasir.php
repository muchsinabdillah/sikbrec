                                            ...
                                            <div class="form-group gut">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single"
                                                        ...
                                                        <!-- <option VALUE="5">Obat Bebas</option> -->
                                                        <option VALUE="2">Rawat Inap</option>
                                                        <!-- <option VALUE="6">Walkin</option> -->
                                                        <option VALUE="3">Rawat Jalan All</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group gut">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single" id="tipeinfo"
                                                        ...
                                                        <!-- <option VALUE="3">Informasi Rekap Per Kasir</option> -->
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group gut">
