                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-warning">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <a type="button" class="btn btn-success btn-animated btn-wide" id="btnLoad" name="btnLoad"><span class="visible-content">Load</span><span class="hidden-content"><i class="fa fa-gear"></i></span></a>
                                            ...
                                            <button class="btn btn-danger btn-animated btn-wide" data-toggle='modal' title="Print PDF" onclick="printpdf()">
                                                    ...
                                                    <table id="datatable1" class="display" width="100%">
                                                        <thead>
                                                            ...
                                                            <th align='center'>No.</th>
                                                                <th align='center'>Tgl Billing</th>
                                                                ...
                                                                <th align='center'>Nama Tarif</th>
                                                                <th align='center'>Total Tarif</th>
                                                                <th align='center'>Nilai Jasa Dokter</th>
...
<script src="<?= BASEURL; ?>/js/App/informasi/billing/Information_JasaDokter.js"></script>