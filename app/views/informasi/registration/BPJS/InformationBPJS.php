                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="JenisRekap"
                                            name="JenisRekap" onchange="clearVal()">
                                            <option VALUE=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="JenisTipe"
                                            name="JenisTipe" onchange="chageV(this)">
                                            <option VALUE=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="GrupPerawatan"
                                            name="GrupPerawatan">
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="NamaDokter"
                                            name="NamaDokter">
                                        </select>
                                    </div>
                                </div>
...
<script src="<?= BASEURL; ?>/js/App/informasi/registration/BPJS/Information_BPJS_V01.js"></script>