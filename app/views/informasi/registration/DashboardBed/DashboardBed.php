                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="Lantai" name="Lantai" onchange="getdataRuangan()">
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="Ruangan" name="Ruangan">
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <table id="datatable" class="display" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align='center'><font size='1'>KodeLokasi</font></th>
                                                <th align='center'><font size='1'>Class</font></th>
                                                <th align='center'><font size='1'>Ward</font></th>
                                                <th align='center'><font size='1'>Bad</font></th>
                                                <th align='center'><font size='1'>TarifKamar</font></th>
                                                <th align='center'><font size='1'>Status</font></th>
                                                <th align='center'><font size='1'>Data Pasien</font></th>
                                                <th align='center'><font size='1'>Booking</font></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
<script src="<?= BASEURL; ?>/js/App/informasi/registration/DashboardBed/DashboardBed.js"></script>