                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="DataRekening" name="DataRekening">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control js-example-basic-single" id="Nopin" name="Nopin">
                                        </select>
                                    </div>
                                </div>
...
<script src="<?= BASEURL; ?>/js/App/informasi/finance/ledger/infoledgerharian.js"></script>