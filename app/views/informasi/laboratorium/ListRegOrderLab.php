                          ...
                          <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                              ...
                              <ul class="nav nav-tabs border-bottom border-primary" role="tablist">
                                  <li role="presentation" class="active"><a class="" href="#datadetil"
                                          aria-controls="datadetil" role="tab" data-toggle="tab">Pasien Rawat Jalan</a>
                                  </li>
                              ...
                              <div class="tab-content bg-white p-15">
                                  ...
                                  <div class="demo-table" width="100%" id="tbl_rekap"
                                          style="margin-top: 10px;overflow-x:auto; ">
                                          <table id="tbl_aktif_walkin" width="100%"
                                              class="table table-striped table-hover cell-border">
                                              <thead>
                                                  <tr>
                                                      <th style="display:none;">Visit Date</th>
...
<script src="<?= BASEURL; ?>/js/App/Informasi/laboratorium/ListRegOrderLab.js"></script>