                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load Master <?= $data['judul'] ?> <button type="button"
                                        ...
                                        onclick="goInputDataBeban();"><span class="visible-content">New Data
                                            Kasbon</span><span class="hidden-content"><i
...
<script src="<?= BASEURL; ?>/js/App/MasterData/MasterBeban/MasterDataBeban_list.js"></script>