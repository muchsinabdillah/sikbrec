                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" id="form_cuti">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Nama Group Beban</label>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" id="NAMA_GROUP_BEBAN" name="NAMA_GROUP_BEBAN">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-2 control-label"> Kode COA </label>
                                                    <div class="col-sm-4">
                                                        <select class="form-control" name="KODE_COA" id="KODE_COA">
                                                        </select>
                                                    </div>
...
<script src="<?= BASEURL; ?>/js/App/MasterData/MasterBeban/MasterDataBeban_View.js"></script>