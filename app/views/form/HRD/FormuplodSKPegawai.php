                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tanggal Awal <sup
                                                class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="tglAwal" name="tglAwal">
                                        </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tanggal Akhir <sup
                                                class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Jenis Doc <sup
                                                class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
                                        ...
                                        <label for="inputEmail3" class="col-sm-2 control-label"> File <sup
                                                class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
...
<script src="<?= BASEURL; ?>/js/App/hrd/upload/uploadDataSKPegawai.js"></script>