                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Jenis Keluarga </label>
                                        <div class="col-sm-4">
                                        <select class="form-control" id="jeniskeluarga" name="jeniskeluarga">
                                                ...
                                                <option value="8">Ayah</option>
                                                <option value="9">Ibu</option>
                                            </select>
                                        </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tpt Lahir </label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="tptkerja" name="tptkerja">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tahun Lahir </label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="tgllahir" name="tgllahir">
                                        </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Nama Keluarga </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" id="jenisdoc" name="jenisdoc">
                                                ...
                                                <option value="KTA">KTA (ANAK)</option>
                                            ...
                                            <table id="example" class="display" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th align='center'> No. </th>
                                                        <th align='center'> Jenis Keluarga </th>
                                                        <th align='center'> Nama</th>
                                                        <th align='center'> Tgl Lahir</th>
                                                        <th align='center'> Tpt Lahir</th>
...
<script src="<?= BASEURL; ?>/js/App/hrd/upload/uploadDataKeluarga.js"></script>