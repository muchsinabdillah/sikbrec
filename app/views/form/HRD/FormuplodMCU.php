                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tanggal MCU</label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="tglMCU" name="tglMCU">
                                        </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tanggal Hasil</label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="tglHasil" name="tglHasil">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <table id="example" class="display" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th align='center'> Tanggal MCU</th>
                                                        <th align='center'> Tanggal Hasil</th>
...
<script src="<?= BASEURL; ?>/js/App/hrd/upload/uploadDataMCU.js"></script>