                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tgl Awal STR </label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="tglAwalSTR" name="tglAwalSTR">
                                        </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tgl Akhir STR </label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="tglAkhirSTR" name="tglAkhirSTR">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="noSuratSTR" name="noSuratSTR">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <table id="example" class="display" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th align='center'> Tgl Awal STR</th>
                                                        <th align='center'> Tgl Akhir STR</th>
...
<script src="<?= BASEURL; ?>/js/App/hrd/upload/uploadDataSTR.js"></script>