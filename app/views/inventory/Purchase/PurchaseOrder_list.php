                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load <?= $data['judul'] ?> <button type="button"
                                        ...
                                        onclick="showInputPurchaseOrdernew();"><span class="visible-content">New Purchase Order</span><span class="hidden-content"><i
...
<script src="<?= BASEURL; ?>/js/App/inventory/Purchase/PurchaseOrder_list.js"></script>