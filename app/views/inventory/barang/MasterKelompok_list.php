                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load Master <?= $data['judul'] ?> <button type="button"
                                        class="btn btn-primary btn-animated btn-wide" onclick="AddNewKelompok();"><span
                                            class="visible-content">New Kelompok Barang</span><span
...
<script src="<?= BASEURL; ?>/js/App/inventory/Barang/MasterKelompokBarang_list.js"></script>