                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load Master <?= $data['judul'] ?> <button type="button"
                                        ...
                                        onclick="showInputDatanew();"><span class="visible-content">New Jenis
                                            Barang</span><span class="hidden-content"><i
...
<script src="<?= BASEURL; ?>/js/App/inventory/Barang/MasterJenisBarang_list.js"></script>