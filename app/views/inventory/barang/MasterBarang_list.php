                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load Master <?= $data['judul'] ?> <button type="button"
                                        class="btn btn-primary btn-animated btn-wide" onclick="NewData();"><span
                                            class="visible-content">New Barang</span><span class="hidden-content"><i
                                ...
                                <table id="example" class="display" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align='center'>
                                                <font size="1">Barcode Code
                                            </th>
                                            <th align='center'>
                                                <font size="1">Nama Product
                                            </th>
                                            <th align='center'>
...
<script src="<?= BASEURL; ?>/js/App/inventory/Barang/MasterDataBarang_list.js"></script>