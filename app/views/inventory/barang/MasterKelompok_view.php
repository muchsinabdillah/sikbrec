                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" id="form_cuti">
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Kode Kelompok </label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="row" style="margin-left:1em;float:left;">
                                                ...
                                                <a class="btn btn-warning" id="btnback" name="btnback"><i class="fa fa-trash" aria-hidden="true"></i>
                                                    Kembali</a>
                                            </div>
                                    </div>
...
<script src="<?= BASEURL; ?>/js/App/inventory/Barang/MasterKelompok.js"></script>