                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load <?= $data['judul'] ?> <button type="button"
                                        ...
                                        onclick="showInputDataPabriknew();"><span class="visible-content">New Data
                                            Pabrik</span><span class="hidden-content"><i
...
<script src="<?= BASEURL; ?>/js/App/inventory/Barang/MasterDataPabrik_list.js"></script>