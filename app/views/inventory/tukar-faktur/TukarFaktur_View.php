                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                <div class="form-group">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-1 control-label"> Supplier <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                        <select name="tf_Suplier" id="tf_Suplier" class="form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group gut">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Periode Hutang <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-1">
                                        <input class="form-control input-sm" type="datetime-local"
                                            id="tf_TglAwalPeriode" name="tf_TglAwalPeriode">
                                    </div>
                                    <label for=" inputEmail3" class="col-sm-1 control-label"> Sampai Dengan <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-1">
                                        <input class="form-control input-sm" type="datetime-local"
                                            id="tf_TglAkhirPeriode" name="tf_TglAkhirPeriode">
                                    </div>
                                </div>
                            </form>
