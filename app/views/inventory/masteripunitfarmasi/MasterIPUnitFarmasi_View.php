                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" autocomplete="off" name="IPAddress" id="IPAddress" placeholder="172.16.40.134">
                                    </div>
                                </div>
                                <div class="form-group">
                                <label for=" inputEmail3" class="col-sm-2 control-label"> Unit <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                    <select name="UnitCode" id="UnitCode" class="form-control" style="width:100%">
                                        </select>
                                    </div>
                                </div>
                            </form>
...
<script src="<?= BASEURL; ?>/js/App/inventory/masteripunitfarmasi/MasterIPUnitFarmasi_View.js"></script>
