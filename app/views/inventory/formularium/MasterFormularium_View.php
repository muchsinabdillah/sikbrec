                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content bg-white p-15">
                                <div id="generalinfo" class="tab-pane fade in active">
                                    <div class="panel-body">
                                        <form class="form-horizontal" id="formtrs">
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Nama Formularium</label>
                                                <div class="col-sm-4">
                                                    <input type="text" placeholder="Masukkan nama formularium" class="form-control" id="Nama_Formularium" name="Nama_Formularium">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left:1em;float:left;">
                                                ...
                                                <a class="btn btn-warning" id="btn_batal" name="btn_batal" onclick="MyBack()"><i class="fa fa-home" aria-hidden="true"></i>
                                                    Kembali</a>
                                            </div>
                                        </form>
                                    </div>
...
<script src="<?= BASEURL; ?>/js/App/inventory/Formularium/MasterFormularium_View.js"></script>