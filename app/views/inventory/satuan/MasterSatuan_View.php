    ...
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                ...
                <p class="sub-title">Silahkan Input Transaksi Data Satuan.</p>
            </div>
            <!-- /.col-md-6 -->
        </div>
        <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-1 control-label"> ID <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" autocomplete="off" name="NamaSatuan" id="NamaSatuan" maxlength="25">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-1 control-label"> ISI <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4"> 
                                        <input type="text" class="form-control" autocomplete="off" name="Isi" id="Isi" maxlength="25">
                                    </div>
                                </div>
                            </form>
...
<script src="<?= BASEURL; ?>/js/App/inventory/satuan/MasterSatuan_View.js"></script>
