                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_hdr">
                                <div class="form-group">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-3 control-label"> No Delivery Order <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="NoDeliveryOrder" id="NoDeliveryOrder"  readonly>
                                    </div>
                                    <div class="col-sm-1">
                                ...
                                <div class="form-group gut">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Lokasi Stok <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                    <input type="hidden" name="LokasiStok" id="LokasiStok" />
                                        <select name="LokasiStokx" id="LokasiStokx" onchange="getIDAwal(this)" class="form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group gut">
                                <label for=" inputEmail3" class="col-sm-2 control-label"> Keterangan <sup class="color-danger">*</sup></label>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select class="form-control js-example-basic-single" id="KodeSupplierx" name="KodeSupplierx" style="width:100%" readonly>
                                        </select>
                                    </div>
                                </div>
                            </form>
...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"> List Data Delivery Orders</h4>
        </div>

        <div class="panel-body">
            <form class="form-horizontal" id="form_cuti">
                <div class="alert alert-success alert-dismissible">
                    <strong>Info !</strong> Silahkan Cari Delivery Order disini.
                </div>
                <div class="form-group gut">
...
<script src="<?= BASEURL; ?>/js/App/inventory/returbeli/ReturBeli_View.js"></script>