                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load <?= $data['judul'] ?> <button type="button"
                                        class="btn btn-maroon btn-animated btn-wide btn-rounded"
                                        onclick="showInputDeliveryOrdernew();"><span class="visible-content">New
                                            Delivery Order</span><span class="hidden-content"><i
...
<script src="<?= BASEURL; ?>/js/App/inventory/Deliveryorder/DeliveryOrder_list.js"></script>