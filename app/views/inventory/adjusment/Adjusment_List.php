                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load Data <?= $data['judul'] ?> <button type="button"
                                        class="btn btn-maroon btn-rounded btn-animated btn-wide"
                        ...
                        <div class="panel-body p-20">
                            <table id="example" class="table demo-table" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th align='center'>
...
<script src="<?= BASEURL; ?>/js/App/inventory/adjusment/Adjusment_List.js"></script>
