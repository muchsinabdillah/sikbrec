                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_hdr">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control js-example-basic-single" id="PO_KodeSupplier"
                                            name="PO_KodeSupplier" style="width:100%">
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row col-sm-8">
                                    ...
                                    <button type="button" class="btn btn-success waves-effect" id="btnFinal"
                                        name="btnFinal" disabled><span class="glyphicon glyphicon glyphicon-saved"
                                            aria-hidden="true"></span> Final Order</button>
                                    ...
                                    <table id="datatable_prdetail" class="display" width="100%">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th align='center'>
                                                    <font size='1'>Tanggal Hutang</font>
                                                </th>
                                                <th align='center'>
                                                    <font size='1'>Keterangan</font>
                                                </th>
                                                <th align='center'>
                                                    <font size='1'>Nilai</font>
                                                </th>
