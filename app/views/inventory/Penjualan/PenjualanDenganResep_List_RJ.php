                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content bg-white p-15">
                                    ...
                                    <div class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                        <div class="form-group ml-20">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input class="form-control input-sm" type="date" id="tglAwal_arsip" autocomplete="off" name="tglAwal_arsip" placeholder="ketik Kata Kunci disini" value="<?= Utils::datenowcreateNotFull() ?>">
                                            </div>
                                            <div class="col-sm-2">
                                                <!-- <label for="form-control input-sm">Input Akhir</label> -->
                                                <input class="form-control input-sm" type="date" id="tglAkhir_arsip" autocomplete="off" name="tglAkhir_arsip" placeholder="ketik Kata Kunci disini" value="<?= Utils::datenowcreateNotFull() ?>">
                                            </div>
                                            <div class="col-sm-2">
                                ...
                                <tr>
                                    <th colspan="8"></th>
                                    <th align="center">
                                        <button type="button" title="Diambil"
                                            class="btn btn-warning btn-xs" id="cb_btndiambil"
                                            name="update_verifikasi" onclick="BtnActionAntrian(this)"> Diambil </button>&nbsp
                                            <!-- <button type="button" title="Diperiksa"
                                            class="btn btn-primary btn-xs" id="cb_btndiperiksa"
                                            name="update_verifikasi" onclick="BtnActionAntrian(this)"> Diperiksa </button>&nbsp
                                            <button type="button" title="Dikemas"
                                            class="btn btn-success btn-xs" id="cb_btndikemas"
                                            name="update_verifikasi" onclick="BtnActionAntrian(this)"> Dikemas </button> -->
                                        <button type="button" title="Resep Selesai"
                                            class="btn btn-success btn-xs" id="cb_btnresepselesai"
                                            name="update_status" onclick="BtnActionAntrian(this)"> Resep Selesai </button>&nbsp
                                        </th>
                                </tr>
                            </tfoot>
                                                </table>
...
<script src="<?= BASEURL; ?>/js/App/inventory/Penjualan/PenjualanDenganResep_List_RJ.js"></script>