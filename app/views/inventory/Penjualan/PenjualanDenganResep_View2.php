                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_hdr">
                                <div class="form-group">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> No. Order Resep<sup class="color-danger">*</sup></label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" autocomplete="off" name="No_Order" id="No_Order" value="<?= $data['id'] ?>" readonly>
                                    </div>
                                    <div class="col-sm-1">
                                        <button type="button" class="btn btn-maroon btn-rounded waves-effect" id="btnSearch" name="btnSearch"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> </btuuon>
                                    </div>
                                ...
                                <div class="form-group gut">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Jenis Kelamin  / No. Episode<sup class="color-danger">*</sup></label>
                                    <div class="col-sm-1">
