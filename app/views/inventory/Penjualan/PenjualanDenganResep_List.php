                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5><?= $data['judul']; ?>
                                    <!-- <button type="button" class="btn btn-danger btn-animated btn-wide" onclick="goGroupShiftPages();"><span class="visible-content"> + Add New
                                            Data</span><span class="hidden-content"><i class="fa fa-send-o"></i></span></button> -->
                                        </h5>
                            </div>
                            <br>
