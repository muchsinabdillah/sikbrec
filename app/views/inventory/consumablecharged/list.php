                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5><?= $data['judul']; ?>
                                <button type="button" class="btn btn-maroon btn-rounded btn-animated btn-wide" onclick="goGroupShiftPages();"><span class="visible-content">New Data</span><span class="hidden-content"><i class="fa fa-send-o"></i></span></button>
                                        </h5>
                            </div>
                            <br>
...
<script src="<?= BASEURL; ?>/js/App/inventory/consumablecharged/list.js"></script>