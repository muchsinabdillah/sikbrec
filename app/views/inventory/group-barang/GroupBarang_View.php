    ...
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                ...
                <p class="sub-title">Silahkan Input Transaksi Group Barang.</p>
            </div>
            <!-- /.col-md-6 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                ...
                                <div class="form-group">
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Nama Group Barang<sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" autocomplete="off" name="NamaGroupBarang" id="NamaGroupBarang" maxlength="25">
                                    </div>
                                </div>
                            </form>
                            <div class="row" style="margin-left:1em;float:left;">
                                ...
                                <a class="btn btn-warning" id="btn_batal" name="btn_batal" onclick="MyBack()"><i class="fa fa-trash" aria-hidden="true"></i>Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?= BASEURL; ?>/js/App/inventory/group-barang/groupbarang_view.js"></script>
