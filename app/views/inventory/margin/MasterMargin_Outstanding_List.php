                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Data List Obat ( Mastering Harga & Margin ) : </h5>
                                <div class="form-group mt-20">
                                    <button type="button" class="btn btn-primary btn-animated btn-wide"
                                        onclick="showdataObatAll();"><span class="visible-content">Show Data Obat
                                            All</span><span class="hidden-content"><i
                                                class="fa fa-send-o"></i></span></button>
                                </div>
                            </div>
                        </div>
