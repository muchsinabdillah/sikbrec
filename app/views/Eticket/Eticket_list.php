                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30">Load <?= $data['judul'] ?> <button type="button"
                                        ...
                                        onclick="showInputTukarFakturnew();"><span class="visible-content">New Data
                                            Tukar Faktur </span><span class="hidden-content"><i
                                ...
                                <table id="example" class="display" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align='center'>
                                                <font size="1">Date Request
                                            </th>
                                            <th align='center'>
                                                <font size="1">Keterangan
                                            </th>
                                            <th align='center'>
                                                <font size="1">User Request
                                            </th>
                                            <th align='center'>
                                                <font size="1">Status
                                            </th>
