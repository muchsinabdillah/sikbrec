                     ...
                     <div class="panel">
                         ...
                         <div class="panel-body p-20">
                             <div class="alert alert-info" role="alert">
                                 <strong>Info !</strong> <b>BPJS Aplicares - 1 : </b> Digunakan untuk Insert dan Delete
                                 Room ke Aplikasi Aplicares BPJS Kesehatan.<br>
                                 <strong>Info !</strong> <b>BPJS Aplicares - 2 : </b> Digunakan untuk Update Data Jumlah
                                 Bed dalam Room ke Aplikasi Aplicares BPJS Kesehatan.
                             </div>
                             <br>
                                     ...
                                     <table id="example" class="display" width="100%">
                                         <thead>
                                             <tr>
                                                 ...
                                                 <th align='center'>
                                                     <font size="1">Room Name
                                                 </th>
                                                 <th align='center'>
                                                     <font size="1">Jumlah Bed
                                                 </th>
                                                 <th align='center'>
                                                     <font size="1">Action
                                                 </th>
                                                 <th align='center'>
                                                     <font size="1">BPJS Aplicares - 1
                                                 </th>
                                                 <th align='center'>
                                                     <font size="1">BPJS Aplicares - 2
                                                 </th>
                                             </tr>
                                         </thead>
                                         <tbody>
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/MasterDataBed/MasterDataRoom_Table_V04.js"></script>
