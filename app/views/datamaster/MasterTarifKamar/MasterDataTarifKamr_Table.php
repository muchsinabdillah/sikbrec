                         ...
                         <div class="panel-body p-20">
                             <form class="form-horizontal" id="frmDataPasien">
                                 <div class="form-group gut">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Pilih Jenis Tarif :
                                     </label>
                                     <div class="col-sm-4">
                                     ...
                                     <table id="example" class="display" width="100%">
                                         <thead>
                                             <tr>
                                                 ...
                                                 <th align='center'>
                                                     <font size="1">Tannggal Berlaku
                                                 </th>
                                                 <th align='center'>
                                                     <font size="1">Tanggal Expired
                                                 </th>
                                                 <th align='center'>
                                                     <font size="1">Action
                                                 </th>
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/MasterDataTarifKamar/MasterDataTarifKamar_Table_V04.js"></script>