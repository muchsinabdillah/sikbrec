                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_cuti">
                                ...
                                <div class="form-group gut">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="JobTitle" id="JobTitle" class="form-control" readonly>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group gut">
                                ...
                                <hr>
                                <div class="panel-title">
                                    <h5>Data Dokter Lanjutan</h5>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label"> Pendidikan </label>
                                    <div class="col-sm-9">
                                        <!-- <input type="text" class="form-control" id="Pelatihan_Dokter" name="Pelatihan_Dokter"> -->
                                        <textarea name="Pendidikan_Dokter" id="Pendidikan_Dokter" class="ckeditor"  ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <!-- <input type="text" class="form-control" id="Description_Dokter"
                                            name="Description_Dokter"> -->

                                        <textarea name="Description_Dokter" id="Description_Dokter" class="ckeditor"  ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <!-- <input type="text" class="form-control" id="Pelatihan_Dokter" name="Pelatihan_Dokter"> -->
                                        <textarea name="Pelatihan_Dokter" id="Pelatihan_Dokter" class="ckeditor" ></textarea>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                    <div class="row" style="margin-right:4em;float:right;">
                                        <a href="#" data-toggle='modal' class="btn btn-danger btn-sm"
                                            onclick="UpdateDataLanjutan()"><span><i class="fa fa-save"></i>Simpan Data
                                                Terbaru</a></span>
