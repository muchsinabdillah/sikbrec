            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <button class="btn bg-danger btn-wide" id="btn_batal" name="btn_batal"><i class="fa fa-trash"></i>Batal</button>
                    </div>
                </div>
            </div>
            <!-- /.col-md-12 -->
...
<script src="<?= BASEURL; ?>/js/App/MasterData/LiburNasional/LiburNasional_View.js"></script>
