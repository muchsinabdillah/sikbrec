                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_add_akses">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                         <select class="form-control js-example-basic-single" id="Mst_ID_Pegawai" name="Mst_ID_Pegawai" readonly></select>
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Kode JO <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <select class="form-control js-example-basic-single" id="Mst_ID_Hak_AksesJO" name="Mst_ID_Hak_AksesJO"></select>
                                     </div>
                                 </div>
                             </form>
                             <button id="btnCancel" name="btnCancel" onclick="MyBack()" class="btn bg-gray btn-wide"><i class="fa fa-times"></i>Cancel</button>
                             <button class="btn bg-black btn-wide" id="btnreservasi" name="btnreservasi" onclick="go_saveHakAksesJO()"><i class="fa fa-check"></i>TAMBAH AKSES</button>
                             <div class="table-responsive" width="100%" style="margin-top: 20px;">
                                 <table id="tblHakAksesJO" class="table table-striped table-hover cell-border">
                                     <thead>
                                         <tr>
                                             <th align='center'>
                                                 <font size="1">No.
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/MasterLoginUser_v05.js"></script>