                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" name="NamaMenu" autocomplete="off" id="NamaMenu">
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Icon <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" id="Icon" autocomplete="off" name="Icon">
                                     </div>
                                 </div>
