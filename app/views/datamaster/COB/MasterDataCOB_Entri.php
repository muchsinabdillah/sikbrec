                            ...
                            <form class="form-horizontal" id="form_cuti">
                                <div class="form-group">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Nama <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="namaCOB" id="namaCOB"
                                            maxlength="25">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Status <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                        <select class="form-control js-example-basic-single" id="statusCOB"
                                            name="statusCOB">
...
<script src="<?= BASEURL; ?>/js/App/MasterData/COB/MasterDataCOB_Entri.js"></script>
