                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <label for=" inputEmail3" class="col-sm-2 control-label"> Nama Karcis <sup
                                             class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" name="NamaKarcis" id="NamaKarcis"
                                             maxlength="25">
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Nilai Karcis <sup
                                             class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" id="NilaiKarcis" name="NilaiKarcis">
                                     </div>
                                     <label for=" inputEmail3" class="col-sm-2 control-label"> Status <sup
                                             class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <select class="form-control js-example-basic-single" id="StatusKarcis"
                                             name="StatusKarcis">
                                 ...
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Grup Tarif <sup
                                             class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <select class="form-control js-example-basic-single" id="GruptarifKarcis"
                                             name="GruptarifKarcis">
