                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-2">
                                         <button class="btn bg-black btn-animated btn-wide" id="btnsave" name="btnsave" onclick="go_view()"><span class="visible-content">Lihat Jadwal</span><span class="hidden-content"><i class="fa fa-plus"></i></span></button>
                                     </div>
                                 </div>
                             </form>
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/MasterDataDokter/MasterDataDokter_Layanan.js"></script>