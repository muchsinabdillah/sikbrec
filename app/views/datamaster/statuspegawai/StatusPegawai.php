                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" name="IdStatusPegawai" id="IdStatusPegawai" value="<?= $data['id'] ?>" readonly>
                                     </div>
                                 ...
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label">Status Pegawai <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" id="NamaStatusPegawai" name="NamaStatusPegawai">
                                     </div>
                                 </div>
                             </form>
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/StatusPegawai_v04.js"></script>