                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                         <select name="CodeMenu" id="CodeMenu" autocomplete="off" class="form-control">
                                         </select>
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Nama Sub Menu <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" id="NamaSubMenu" autocomplete="off" name="NamaSubMenu" maxlength="150">
                                     </div>
                                     <label for=" inputEmail3" class="col-sm-2 control-label"> URL </label>
                                     <div class="col-sm-4">
                                         <input type="text" autocomplete="off" class="form-control" id="UrlSubMenu" name="UrlSubMenu" maxlength="250">
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Icon </label>
                                     <div class="col-sm-4">
                                         <input type="text" autocomplete="off" class="form-control" id="IconSubMenu" name="IconSubMenu" maxlength="150">
                                     </div>
                                 </div>
                             </form>
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/MasterDataSubMenu/MasterDataSubMenu_V01.js"></script>