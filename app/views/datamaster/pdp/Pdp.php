                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" name="KodePdp" id="KodePdp" maxlength="10">
                                         <small>Maksimal 10 Character, Contoh : PSD00000001.</small>
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Nama Pdp <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" id="NamaPdp" name="NamaPdp">
                                     </div>
                                     <label for=" inputEmail3" class="col-sm-2 control-label"> Jenis Pdp <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" maxlength="6" name="KodeJenisPdp" id="KodeJenisPdp">
                                         <small>Maksimal 6 Character, Contoh : PROSEN.</small>
                                     </div>
                                 </div>
                             </form>
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/keuangan/Pdp_V04.js"></script>