                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" id="form_cuti">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                         <input type="text" class="form-control" name="IdJabatan" id="IdJabatan" value="<?= $data['id'] ?>" readonly>
                                     </div>
                                     <label for=" inputEmail3" class="col-sm-2 control-label"> Status <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-2">
                                         <select class="form-control" id="StatusJabatan" name="StatusJabatan">
                                 ...
                                 <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Nama Jabatan <sup class="color-danger">*</sup></label>
                                     <div class="col-sm-4">
 ...
 <script src="<?= BASEURL; ?>/js/App/MasterData/Jabatan_v03.js"></script>
