                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                ...
                                <div class="form-group jenispembayaran gut">
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Nomor SEP <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                        <div class="col-sm-6">
                                            <input class="form-control input-sm" type="text" id="PasienNoBooking" name="PasienNoBooking" placeholder="Masukkan nomor SEP disini">
                                ...
                                <div class="from-group tglmasuk gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Tanggal Masuk <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control input-sm" required>
                                    </div>
                                </div>
                                <div class="form-group tglkeluar gut">
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Tanggal Keluar <sup class="color-danger">*</sup></label>
                                ...
                                <div class="from-group jaminan gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Jaminan <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                ...
                                <div class="from-group poli gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Poli <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                ...
                                <div class="from-group ruangrawat gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Ruang Rawat <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-4">
                                ...
                                <div class="from-group poli gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Kelas Rawat <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                ...
                                <div class="from-group poli gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Spesialistik <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                ...
                                <div class="from-group poli gut">
                                    <label for="tglmasuk" class="col-sm-2 control-label">Cara Keluar <sup class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
