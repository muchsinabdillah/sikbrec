                                ...
                                <div class="form-group">
                                    ...
                                    <a type="button" class="btn btn-danger btn-animated btn-wide "
                                        id="btnLoadInformation" name="btnLoadInformation"><span
                                            class="visible-content"><i class="fa fa-search"></i>Search</span><span
...
<script src="<?= BASEURL; ?>/js/App/finance/informasirekapsisahutang.js"></script>