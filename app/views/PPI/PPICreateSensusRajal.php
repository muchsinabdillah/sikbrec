                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form_PPI">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="teks" class="form-control" name="IdAuto" id="IdAuto"
                                            value="<?= $data['id'] ?>" readonly>
                                    </div>
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Tipe Rawat <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="SensusTipeRawat"
                                            id="SensusTipeRawat" value="Rawat Jalan" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Tanggal <sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Jumlah Pasien<sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" name="Sensusjumlah" id="Sensusjumlah">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-2 control-label">Jumlah Operasi<sup
                                            class="color-danger">*</sup></label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" name="SensusOpr" id="SensusOpr"
                                            readonly>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusB" id="SensusB"
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusBC" id="SensusBC"
                                            onkeyup="CalculateALL()">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusC" id="SensusC"
                                            onkeyup="CalculateALL()">
                                    </div>
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusK" id="SensusK"
                                            onkeyup="CalculateALL()">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusETTVENT"
                                            id="SensusETTVENT">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusJKD" id="SensusJKD"
                                            readonly>
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">Swab : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusJKS" id="SensusJKS"
                                            readonly>
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">Sputum : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusJKSPT" id="SensusJKSPT"
                                            readonly>
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">Urine : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusJKUR" id="SensusJKUR"
                                            readonly>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM01"
                                            id="SensusDarahKM01" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM01 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM01"
                                            id="SensusSwabKM01" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM01 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM01"
                                            id="SensusSputumKM01" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM01 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM01"
                                            id="SensusUrineKM01" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM02"
                                            id="SensusDarahKM02" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM02 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM02"
                                            id="SensusSwabKM02" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM02 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM02"
                                            id="SensusSputumKM02" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM02 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM02"
                                            id="SensusUrineKM02" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM03"
                                            id="SensusDarahKM03" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM03 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM03"
                                            id="SensusSwabKM03" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM03 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM03"
                                            id="SensusSputumKM03" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM03 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM03"
                                            id="SensusUrineKM03" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM04"
                                            id="SensusDarahKM04" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM04 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM04"
                                            id="SensusSwabKM04" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM04 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM04"
                                            id="SensusSputumKM04" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM04 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM04"
                                            id="SensusUrineKM04" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM05"
                                            id="SensusDarahKM05" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM05 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM05"
                                            id="SensusSwabKM05" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM05 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM05"
                                            id="SensusSputumKM05" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM05 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM05"
                                            id="SensusUrineKM05" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM06"
                                            id="SensusDarahKM06" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM06 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM06"
                                            id="SensusSwabKM06" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM06 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM06"
                                            id="SensusSputumKM06" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM06 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM06"
                                            id="SensusUrineKM06" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM07"
                                            id="SensusDarahKM07" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM07 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM07"
                                            id="SensusSwabKM07" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM07 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM07"
                                            id="SensusSputumKM07" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM07 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM07"
                                            id="SensusUrineKM07" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM08"
                                            id="SensusDarahKM08" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM08 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM08"
                                            id="SensusSwabKM08" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM08 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM08"
                                            id="SensusSputumKM08" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM08 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM08"
                                            id="SensusUrineKM08" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM09"
                                            id="SensusDarahKM09" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM09 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM09"
                                            id="SensusSwabKM09" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM09 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM09"
                                            id="SensusSputumKM09" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM09 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM09"
                                            id="SensusUrineKM09" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM10"
                                            id="SensusDarahKM10" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM10 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM10"
                                            id="SensusSwabKM10" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM10 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM10"
                                            id="SensusSputumKM10" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM10 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM10"
                                            id="SensusUrineKM10" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM11"
                                            id="SensusDarahKM11" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM11 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM11"
                                            id="SensusSwabKM11" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM11 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM11"
                                            id="SensusSputumKM11" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM11 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM11"
                                            id="SensusUrineKM11" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM12"
                                            id="SensusDarahKM12" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM12 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM12"
                                            id="SensusSwabKM12" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM12 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM12"
                                            id="SensusSputumKM12" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM12 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM12"
                                            id="SensusUrineKM12" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM13"
                                            id="SensusDarahKM13" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM13 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM13"
                                            id="SensusSwabKM13" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM13 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM13"
                                            id="SensusSputumKM13" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM13 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM13"
                                            id="SensusUrineKM13" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM14"
                                            id="SensusDarahKM14" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM14 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM14"
                                            id="SensusSwabKM14" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM14 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM14"
                                            id="SensusSputumKM14" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM14 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM14"
                                            id="SensusUrineKM14" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusDarahKM15"
                                            id="SensusDarahKM15" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM15 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSwabKM15"
                                            id="SensusSwabKM15" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM15 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusSputumKM15"
                                            id="SensusSputumKM15" onkeyup="CalculateALL()">
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label">KM15 : </label>
                                    <div class="col-sm-1">
                                        <input type="number" class="form-control" name="SensusUrineKM15"
                                            id="SensusUrineKM15" onkeyup="CalculateALL()">
                                    </div>
                                </div>
                                <br>
                                <button id="btnCancel" name="btnCancel" onclick="MyBack()"
                                    class="btn bg-gray btn-wide"><i class="fa fa-times"></i>Cancel</button>
                                <button class="btn bg-black btn-wide" id="btnsubmit" name="btnsubmit"><i
                                        class="fa fa-check"></i>Submit</button>
                                <hr>

                                <div class="demo-table" style="margin-top: 70px;">
                                    <h6> Keterangan </h6>
