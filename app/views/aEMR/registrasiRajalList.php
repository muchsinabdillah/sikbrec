                            ...
                            <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                ...
                                <ul class="nav nav-tabs border-bottom border-primary" role="tablist">
                                    <li role="presentation" class="active"><a class="" href="#datadetil"
                                            aria-controls="datadetil" role="tab" data-toggle="tab">Pasien Aktif</a>
                                    </li>
            ...
            <div class="modal-body">
                <form id="frmUpdateSEP">
                    ...
                    <div class="row" style="margin-bottom:3px;">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control input-sm" type="text" id="Noreg" name="Noreg" maxlength="19"
                                readonly>
                            <input class="form-control input-sm" type="hidden" id="No_MR" name="No_MR" maxlength="19"
                                readonly>
                            <input class="form-control input-sm" type="text" id="NoPesertaBPJS" name="NoPesertaBPJS"
                                maxlength="19" readonly>
                            <input class="form-control input-sm" type="hidden" id="NO_RUJUKAN" name="NO_RUJUKAN"
                                maxlength="19" readonly>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom:3px;">
                    ...
                    <div class="row" style="margin-bottom:3px;">
                        ...
                        <div class="col-sm-1" style="margin-left: -25px;">
                            <a href="#" data-toggle='modal' class="btn btn-primary btn-sm" onclick="verifySEp()"><span
                                    class="glyphicon glyphicon glyphicon-search"></span>Verify</a>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom:3px;">
                        <label for="namapasien" class="col-sm-4 col-form-label">Hak Kelas BPJS :</label>
                        <div class="col-sm-4">
                            <input class="form-control input-sm" type="text" autocomplete="off" id="hakKelasBPJS"
                                name="hakKelasBPJS" maxlength="19">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom:3px;">
                        <label for="namapasien" class="col-sm-4 col-form-label">PRB / Prolanis :</label>
                        <div class="col-sm-4">
                            <input class="form-control input-sm" type="text" autocomplete="off" id="keteranganprbBPJS"
                                name="keteranganprbBPJS" maxlength="19">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom:3px;">
                        <label for="namapasien" class="col-sm-4 col-form-label">diagnosa Ina cbg :</label>
                        <div class="col-sm-4">
                            <input class="form-control input-sm" type="text" autocomplete="off" id="diagnosaInacbg"
                                name="diagnosaInacbg" maxlength="19">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom:3px;">
                        <label for="namapasien" class="col-sm-4 col-form-label">Nilai Gruper :</label>
                        <div class="col-sm-4">
                            <input class="form-control input-sm" type="text" autocomplete="off" id="nilai_Gruper"
                                name="nilai_Gruper" maxlength="19">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom:3px;">
                        <label for="namapasien" class="col-sm-4 col-form-label">lama di rawat :</label>
                        <div class="col-sm-4">
                            <input class="form-control input-sm" type="text" autocomplete="off" id="lama_dirawat"
                                name="lama_dirawat" maxlength="19">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button data-toggle='modal' class="btn btn-warning btn-sm" type="button" id="btnUpdateSEP_Manual"
                    name="btnUpdateSEP_Manual">
                    PASIEN MASUK RANAP
                </button>
                <button data-toggle='modal' class="btn btn-danger btn-sm" type="button" id="btnUpdateSEP"
                    name="btnUpdateSEP">
                    UPDATE NO SEP
                </button>
            </div>
...
<div class="modal fade" id="modal_AntrolJenisKunungan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog  modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="frmBatalReg">
                    <div class="form-group  ">
                        ...
                        <div class="col-sm-6">
                            <select id="AntrolJenisKunungan" name="AntrolJenisKunungan" style="width: 100%;"
                                class="form-control ">
            ...
            <div class="modal-footer">
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-primary btn-wide btn-rounded" id="btnSendAntrol"
                        name="btnSendAntrol"><i class="fa fa-plus"></i> Send </button>
                    <button type="button" class="btn btn-gray btn-wide btn-rounded" id="btnSendAntrolClose"
...
<script src="<?= BASEURL; ?>/js/App/registration/list/registrasiRajalList.js"></script>