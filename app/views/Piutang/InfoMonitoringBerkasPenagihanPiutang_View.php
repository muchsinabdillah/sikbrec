                                    ...
                                    <div class="panel panel-warning">
                                        <div class="panel-heading">
                                            <header class="w3-container w3-indigo" style="padding:5px">
                                                <span class="glyphicon glyphicon-envelope"></span> Masukan Periode dan Jenis Jaminan
                                            </header>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group gut">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single" id="JenisJaminan" name="JenisJaminan" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;">
                                                        <option value=""></option>
                                                        ...
                                                        <table id="table-load-data" class="display" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th align='center'>
                                                                        <font size="1">No. Penagihan
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Tgl Piutang
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Jenis Penjamin
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Nama Penjamin
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">FS_Ket
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Total Tagih
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Periode Awal
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Periode Akhir
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Jenis Regis
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Tgl Input
                                                                    </th>
                                                                    </th>
                                                                    <th align='center'>
...
<script src="<?= BASEURL; ?>/js/App/Informasi/Piutang/InfoMonitoringBerkasPiutang.js"></script>