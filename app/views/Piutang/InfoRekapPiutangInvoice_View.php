                                    ...
                                    <div class="panel panel-warning">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group gut">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single" id="JenisInfo" name="JenisInfo" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;" onchange="chage(this)">
                                                        <option value=""></option>
                                                        <option VALUE="0">Per Invoice</option>
                                                        <option VALUE="1">Per Jaminan</option>
                                                        <option VALUE="2">Per Pasien</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group gut">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control js-example-basic-single" id="TipePenjamin" name="TipePenjamin" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;" onchange="getIDPenjamin()" onchange="chageV(this)">
                                                        <option value=""></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <select class="form-control js-example-basic-single" id="NamaPenjamin" name="NamaPenjamin" style="background-color: transparent;border-color: transparent; border-bottom: 1px solid darkgrey; border-radius: 0px; width: 300px;">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="panel panel-danger">
                                                ...
                                                <div class="panel-body">
                                                    <div class="demo-table" style="overflow-x:auto;">
                                                        <table id="datatable_invoice" class="display" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th align='center'>
                                                                        <font size="1">NO.
                                                                    ...
                                                                    <th align='center'>
                                                                        <font size="1">Nomor Invoice
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Nama Perusahaan
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Tgl. Kirim
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Tgl. terima
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Umur Piutang
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Piutang
                                                                    </th>
                                                                    ...
                                                                    <th align='center'>
                                                                        <font size="1">Sisa Piutang
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Keterangan
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Total Pasien
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                                        </table>

                                                        <table id="datatable_Jaminan" class="display" width="100%" style="display: none;">
                                                            <thead>
                                                                <tr>
                                                                    <th align='center'>
                                                                        <font size="1">No
                                                        ...
                                                        <table id="datatable_Pasien" class="display" width="100%" style="display: none;">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th align='center'>
                                                                        <font size="1">Tgl. Dikirim
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Tgl. Diterima
                                                                    </th>
                                                                    <th align='center'>
                                                                        <font size="1">Umur Piutang
                                                                    </th>
...
<script src="<?= BASEURL; ?>/js/App/Informasi/Piutang/InfoRekapPiutangInvoice.js"></script>