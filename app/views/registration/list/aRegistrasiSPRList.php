                        ...
                        <div class="panel-body">
                            <!--
                             ...
                             <form class="form-horizontal" id="form_cuti"> 
                                 ...
                                 <button type="button" class="btn btn-success btn-animated btn-wide" id="btnLoadInformation" name="btnLoadInformation" onclick="goGroupShiftPages();"><span class="visible-content">Load</span><span class="hidden-acontent"><i class="fa fa-gear"></i></span></button>
                                 </div>
                                -->
                            <hr>
                                ...
                                <table id="permintaanrawat_all" class="display" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align='center'>
                                                <font size="1">Dokter Req
                                            </th>
                                            <th align='center'>
                                                <font size="1">DPJP Rawat Inap
                                            </th>
                                            <th align='center'>
                                                <font size="1">Penjamin
                                            </th> 
                                            <th align='center'>
                                                <font size="1">Action
                                            </th> 
...
<script src="<?= BASEURL; ?>/js/App/registration/list/listregistratrationranap_V031.js"></script>