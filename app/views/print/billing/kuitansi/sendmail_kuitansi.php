...
$mail = new PHPMailer(true);
    ...
    $mail->FromName  = 'KUITANSI';
    $mail->IsHTML(true);

    $mail->Subject   = 'Kuitansi';
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont,  Roboto, Helvetica, Arial, sans-serif, ; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">RS yarsi</p>
   ...
   // $mail->addCC($emailcc);
    $mail->addStringAttachment(file_get_contents($data['listdata1']['AwsUrlDocuments']), 'KUITANSI-'.$data['listdata1']['ID'], $encoding = 'base64', $type = 'application/pdf');
