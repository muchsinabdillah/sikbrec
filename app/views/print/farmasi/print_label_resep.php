...
$pdf->Cell(2,4,':',0,0);
$pdf->CellFitScale(50,4,$data['listdata1']['NamaPasien'],0,1);
//$pdf->Cell(0,1,'',0,1);//br
$gety = $pdf->getY();
...
$pdf->Cell(2,4,':',0,0);
$pdf->Cell(20,4,$data['listdata1']['NoMR'],0,0);

$pdf->Cell(-5,3,'',0,0);//margin
$pdf->Cell(12,4,'Tgl Lahir',0,0);
$pdf->Cell(2,4,':',0,0);
$pdf->Cell(116,4,date('d/m/Y', strtotime($data['listdata1']['Date_of_birth'])),0,1);

$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(12,4,'No Resep',0,0);
$pdf->Cell(2,4,':',0,0);
$pdf->Cell(20,4,$data['listdata1']['NoResep'],0,1);

$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(12,4,'Tgl Resep',0,0);
$pdf->Cell(2,4,':',0,0);
$pdf->Cell(20,4,date('d/m/Y', strtotime($data['listdata1']['tglResep'])),0,0);
...
$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(56,4,$data['listdata1']['ProductName']. ' ('.$data['listdata1']['QtyRealisasi'].' '.$data['listdata1']['UnitSatuan'].')','TB',1,'C');

$pdf->setFont('Arial','',7);

$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(56,4,$data['listdata1']['Composisi'],0,1,'C');
$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(56,4,$data['listdata1']['Signa'],0,1,'C');
$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(56,4,$data['listdata1']['Note2'],0,1,'C');
$pdf->Cell(-6,1,'',0,0);//margin
$pdf->Cell(56,4,$data['getSignaObat']['Signa'].' - Expired Date :'.$data['listdata1']['ED'],0,1,'C');
