...
$mail = new PHPMailer(true);
    ...
    $mail->FromName  = 'PERKIRAAN BIAYA PERAWATAN NON OPERASI';
    $mail->IsHTML(true);

    $mail->Subject   = 'Perkiraan Biaya Perawatan Non Operasi';
...
Ditempat</p>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont,  Roboto, Helvetica, Arial, sans-serif, ; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Berikut kami lampirkan perkiraan biaya perawatan non operasi yang telah dilakukan di RS yarsi.</p>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont,  Roboto, Helvetica, Arial, sans-serif, ; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">RS yarsi</p>
    ...
    ';
    $email_to = 'abdullahfiqri24@gmail.com';
    //$email_to = $data[''];
    $mail->AddAddress($email_to);
   // $mail->addCC($emailcc);
    $mail->addStringAttachment(file_get_contents($data['listdata1']['AwsUrlDocuments']), 'PERKIRAANBIAYANONOP-'.$data['listdata1']['ID'].'-'.$data['listdata1']['NamaPasien'], $encoding = 'base64', $type = 'application/pdf');
