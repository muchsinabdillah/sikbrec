...
try {
    ...
    Ditempat</p>
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont,  Roboto, Helvetica, Arial, sans-serif, ; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Berikut kami lampirkan file.</p>
    ...
    //$mail->addAttachment(''); 
    $mail->addStringAttachment(file_get_contents($data['listdata1']['AwsUrlDocuments']), $data['judul'].'-'.$data['listdata1']['ID'].'-'.$data['listdata1']['NamaPasien'], $encoding = 'base64', $type = 'application/pdf');
