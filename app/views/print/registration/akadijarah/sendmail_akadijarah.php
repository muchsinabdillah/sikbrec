...
$mail = new PHPMailer(true);
    ...
    $mail->FromName  = 'AKAD IJARAH';
    $mail->IsHTML(true);

    $mail->Subject   = 'Akad Ijarah';
...
Ditempat</p>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont,  Roboto, Helvetica, Arial, sans-serif, ; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Berikut kami lampirkan akad ijarah yang telah dilakukan di RS yarsi.</p>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont,  Roboto, Helvetica, Arial, sans-serif, ; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">RS yarsi</p>
   ...
   // $mail->addCC($emailcc);
    $mail->addStringAttachment(file_get_contents($data['listdata1']['AwsUrlDocuments']), 'AKADIJARAH-'.$data['listdata1']['ID'].'-'.$data['listdata1']['NamaPasien'], $encoding = 'base64', $type = 'application/pdf');
