                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content bg-white p-15">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="pasienaktif">
                                    ...
                                    <div class="form-group">
                                        <form class="form-horizontal" id="form_periode">
                                            ...
                                            &nbsp&nbsp&nbsp&nbsp
                                            <button type="button" class="btn-sm btn-primary" id="btn_viewall"
                                                name="btn_viewall"><span class="glyphicon glyphicon-filter"
                                                    aria-hidden="true"></span> Lihat Semua</span></button>
                                            &nbsp&nbsp&nbsp&nbsp
                                ...
                                <div role="tabpanel" class="tab-pane" id="pasienarsip">
                                    ...
                                    <!-- <div class="table-responsive" style="margin-top: 70px;">
                                <table id="listbillingranap_arsip" class="display" width="100%"> -->
                                    <div class="panel-body">
                                        <div class="demo-table" style="overflow-x:auto;">
                                            <table id="listbillingranap_arsip" class="display" width="100%">
                                                <thead>
...
<script src="<?= BASEURL; ?>/js/App/billing/List/listbillingranap.js"></script>