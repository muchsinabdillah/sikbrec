                            ...
                            <div class="tab-content bg-white p-15">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="pasienaktif">
                                    ...
                                    <!-- <div class="table-responsive" style="margin-top: 70px;">
                                                <table id="listbillingwalkin" class="display" width="100%"> -->
                                    <div class="panel-body">
                                ...
                                <div role="tabpanel" class="tab-pane" id="pasienarsip">
                                    ...
                                    <!-- <div class="table-responsive" style="margin-top: 70px;">
                                <table id="listbillingwalkin_arsip" class="display" width="100%"> -->
                                    <div class="panel-body">
                                        <div class="demo-table" style="overflow-x:auto;">
                                            <table id="listbillingwalkin_arsip" class="display" width="100%">
                                                <thead>
...
<script src="<?= BASEURL; ?>/js/App/billing/List/listbillingwalkin.js"></script>