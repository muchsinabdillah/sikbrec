                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs border-bottom border-primary" role="tablist">
                                <li role="presentation" class="active"><a class="" href="#reservasi_aktif"
                                        aria-controls="reservasi_aktif" role="tab" data-toggle="tab">Transaksi Booking</a>
                                </li>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="reservasi_aktif">
                                    <div class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                        <div class="form-group">
                                            <h3>Cari Data Booking Tempat Tidur</h3>
                                            <div class="col-sm-2">
                                      ...
                                      <div class="col-sm-2">
                                          <button type="button" onclick="GoMonitoringBPJS();" id="caridatapasienarsip"
                                              class="btn btn-success btn-wide btn-rounded"><i
                                                  class="fa fa-search"></i>Search Surat Kontrol</button>
                                      </div>
                        </div>
                        <br><br>
...
<script src="<?= BASEURL; ?>/js/App/BookingKamar/BookingKamar_List.js"></script>