                    ...
                    <div class="panel border-primary no-border border-3-top" data-panel-control>
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5 class="underline mt-30"><?= $data['judul'] ?> <small>Daily Report Transaction, please entri. </small></h5>
                                <br><button class="btn btn-primary" id="btnreservasi" name="btnreservasi" onclick="newTrsAbsensiManual()">NEW</button>
                            </div>
                        </div>
