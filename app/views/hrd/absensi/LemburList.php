                    ...
                    <div class="panel border-primary no-border border-3-top" data-panel-control>
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <br><button class="btn btn-primary" id="btnreservasi" name="btnreservasi" onclick="newTrsLembur()">NEW</button>
                            </div>
                        </div>
                                ...
                                <table id="example" class="table table-striped table-hover cell-border">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align='center'>
                                                <font size="1">Tanggal Lembur
                                            </th>
                                            <th align='center'>
                                                <font size="1">Jam Awal
                                            </th>
                                            <th align='center'>
                                                <font size="1">Jam Akhir
                                            </th>
                                            <th align='center'>
