<?php
                      ...
                      <div class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                  <h5 class="underline mt-30">DATA PENGAJUAN BON SEMNTARA</h5>
                                  <div class="form-group  "> 
                                      <label for="inputEmail3" class="col-sm-2 control-label"> No. Pengajuan <sup class="color-danger">*</sup></label>
                                      <div class="col-sm-1">
                                          <input class="form-control input-sm" maxlength="8" readonly autocomplete="off" type="text" id="noTrs" name="noTrs" value="<?= $data['id'] ?>">
                                      </div>
                                      <div class="col-sm-3">
                                      ...
                                      <label for="inputEmail3" class="col-sm-2 control-label"> Nilai Pengajuan<sup class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
                                          <input class="form-control input-sm" autocomplete="off" type="text" id="NilaiPengajuan" name="NilaiPengajuan">
                                        </div>
                                  </div> 
                                  <div class="form-group gut "> 
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Tgl Pengajuan<sup class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
                                          <input class="form-control input-sm" type="datetime-local" id="TglPengajuan" name="TglPengajuan"  step="1">
                                        </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Nama Pegawai<sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                          <select id='NamaPegawai' style="width: 100%;" name='NamaPegawai' onchange="shwoOutstandingPenyelesaian()" class="form-control">
                                          </select>
                                      </div>
                                  </div> 
                                  <div class="form-group gut">
                                      ...
                                      <div class="col-sm-4">
                                          <select id='TipePengajuan' style="width: 100%;" name='TipePengajuan' class="form-control">
                                              <option value="">-- PILIH --</option>
                                              <option value="REGULER">REGULER</option>
                                              <option value="CITO">CITO</option>
                                          </select>
                                      </div>
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Keterangan Pengajuan<sup class="color-danger">*</sup></label>
                                        <div class="col-sm-4">
                                        <textarea class="form-control input-sm" id="KeteranganPengajuan" name="KeteranganPengajuan" rows="4" style="resize: none"></textarea>
                                        </div> 
                                  </div>  
                              </form>
                              <h5 class="underline mt-30">DATA OUTSTANDING REALISASI BON SEMENTARA</h5>
                                  <div class="alert alert-success alert-dismissible">
                                      <p> <strong>Info !</strong> Jika terdapat outstanding, Harap selesaikan dahulu.</p>
                                  </div>
                                  <div class="demo-table" style="overflow-x:auto;">
                                          <table id="tbl_arsip" class="display" width="100%">
                                              ...
                                              <thead>
                                                  <tr>
                                                      ...
                                                      <th align='center'>
                                                          <font size="1">No. Trs Pencairan
                                                      </th>
                                                      <th align='center'>
                                                          <font size="1">Tanggal Pencairan
                                                      </th>
                                                      <th align='center'>
                              ...
                              <div class="btn-group" role="group">
                                  ...
                                  <button class="btn btn-primary  btn-rounded " id="creates" name="creates"><i class="fa fa-save"></i> SIMPAN</button>
                                  <button class="btn btn-danger  btn-rounded " id="btnbatal" name="btnbatal"><i class="fa fa-trash"></i> BATAL</button>
                                  <button class="btn btn-secondary  btn-rounded " id="close" name="close" onclick="MyBack()">
                                      <i class="fa fa-mail-reply-all"></i> KEMBALI</button>
                              </div>
  ...
  <script src="<?= BASEURL; ?>/js/App/finance/entripengajuanbonsementara.js"></script>