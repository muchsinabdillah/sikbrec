                      ...
                      <div class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                  <h5 class="underline mt-30">DATA PENGAJUAN BON SEMENTARA</h5>
                                  <div class="form-group  ">
                                      <label for="inputEmail3" class="col-sm-2 control-label"> No. Order <sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                          <input class="form-control input-sm" maxlength="15" readonly autocomplete="off" type="text" id="IDNoTrsPencairan" name="IDNoTrsPencairan" value="<?= $data['id'] ?>">
                                      </div>
                                      <label for="inputEmail3" class="col-sm-2 control-label"> No. Pengajuan <sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                          <input class="form-control input-sm" maxlength="8" readonly autocomplete="off" type="text" id="noTrsPencairan" name="noTrsPencairan">
                                      </div>
                                  </div>
                                  <div class="form-group gut ">
                                  <label for="inputEmail3" class="col-sm-2 control-label"> Tgl Pengajuan<sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                          <input class="form-control input-sm" readonly autocomplete="off" type="text" id="tglPencairan" name="tglPencairan">
                                      </div>
                                      <label for=" inputEmail3" class="col-sm-2 control-label"> Nilai Pengajuan <sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                          <input class="form-control input-sm" autocomplete="off" readonly type="text" id="NominalPencairan" name="NominalPencairan">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group gut ">
                                      ...
                                      <div class="col-sm-4">
                                          <select id='TipeKasbon' style="width: 100%;" name='TipeKasbon' class="form-control">
                                      ...
                                      <label for="inputEmail3" class="col-sm-2 control-label"> Nama Pegawai </label>
                                        <div class="col-sm-4">
                                          <select id='NamaPegawai' style="width: 100%;" name='NamaPegawai' class="form-control">
                                          </select>
                                        </div>
                                       
                                  </div>
                                    <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label"> Keterangan Realisasi<sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                      <textarea class="form-control input-sm" readonly id="KeteranganPencairan" name="KeteranganPencairan" rows="4" style="resize: none"></textarea>
                                      </div>  
                                    </div>
                                  <h5 class="underline mt-30">DATA REALISASI BON SEMNTARA</h5>
                                  <div class="alert alert-success alert-dismissible">
                                      <p> <strong>Info !</strong> Untuk Penyelesaian Tanpa Order ( CITO ), silahkan masukan data yang di butuhkan, lalu klik tombol CREATE REALISASI.</p>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputEmail3" class="col-sm-2 control-label"> Nilai Realisasi<sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                                          <input class="form-control input-sm" autocomplete="off" type="text" id="NilaiPenyelesaian" name="NilaiPenyelesaian">
                                      </div>
                                      <label for="inputEmail3" class="col-sm-2 control-label"> Tgl Realisasi<sup class="color-danger">*</sup></label>
                                      <div class="col-sm-4">
                              ...
                              <div class="btn-group" role="group">
                                  ...
                                  <button class="btn btn-primary  btn-rounded " id="savetrs" name="savetrs"><i class="fa fa-save"></i> SELESAI</button>
                                  <button class="btn btn-danger  btn-rounded " id="btnbatal" name="btnbatal"><i class="fa fa-trash"></i> BATAL PENYELESAIAN</button>
  ...
  <script src="<?= BASEURL; ?>/js/App/finance/penyelesaiankasbon.js"></script>