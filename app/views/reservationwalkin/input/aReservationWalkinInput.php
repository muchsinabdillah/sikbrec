                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="frmSimpanTrsRegistrasi">
                                ...
                                <div class="form-group alamat gut">
                                    ...
                                    <label for=" inputEmail3" class="col-sm-2 control-label"> Tanda </label>
                                    <div class="col-sm-4">
...
<script>
    $(document).ready(function() {
        ReservationWalkininput();

    });

    function ReservationWalkininput() {
        $(".preloader").fadeOut();
    }
...
<script src="<?= BASEURL; ?>/js/App/reservation/walkin/reservationwalkin_v01.js"></script>
<script src="<?= BASEURL; ?>/js/pnotify/pnotify.custom.min.js"></script>
