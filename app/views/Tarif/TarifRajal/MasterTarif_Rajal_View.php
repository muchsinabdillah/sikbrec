<div class="main-page">
                         ...
                         <div class="panel-body">
                             ...
                             <div class="tab-content bg-white p-15">
                                     ...
                                     <div class="panel-body">
                                         ...
                                         <input type="hidden" class="form-control" name="kd_instalasi" id="kd_instalasi" value="<?= $data['kd_instalasi'] ?>" readonly>
                                             <div class="form-group">
                                                 ...
                                                 <label for=" inputEmail3" class="col-sm-2 control-label"> Nama Tarif <sup class="color-danger">*</sup></label>
                                                 <div class="col-sm-4">
                                                     <input type="text" class="form-control" name="NamaTarif" id="NamaTarif" >
                                                 </div>
                                             </div>
                                             <div class="form-group">
                                             <label for="inputEmail3" class="col-sm-2 control-label"> Kode Produk </label>
                                                 ...
                                                 <select class="form-control" id="CategoryProduct" name="CategoryProduct">
                                                        ...
                                                        <option value="Consumable (BHP)">Consumable (BHP)</option>
                                                        <option value="Elektrodiagnostik">Elektrodiagnostik</option>
                                                        <option value="Konsultasi">Konsultasi</option>
                                                        <option value="Sewa Alat Medis">Sewa Alat Medis</option>
                                                        <option value="Tindakan">Tindakan</option>
                                                        <option value="Tindakan Fisioteraphy">Tindakan Fisioteraphy</option>
                                                        <option value="Tindakan Paket">Tindakan Paket</option>
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <label for=" inputEmail3" class="col-sm-2 control-label"> Kode Jasa <sup class="color-danger">*</sup></label>
                                                 <div class="col-sm-4">
                                                 <select name="KodeJasa" id="KodeJasa" class="form-control" style="width:100%">
                                                    </select>
                                                 </div>
                                             </div>
                                 ...
                                 <div id="layanan" class="tab-pane fade">
                                     ...
                                     <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label"> Cari Layanan</label>
                                     <div class="col-sm-4">
                                         <select name="GrupPerawatan" id="GrupPerawatan" class="form-control" style="width:100%">
                                         </select>
                                     </div>
                                     <div class="col-sm-4">
                                         <button class="btn bg-black btn-animated btn-wide" id="btnSave" name="btnSave"><span class="visible-content">Add</span><span class="hidden-content"><i class="fa fa-plus"></i></span></button>
                                     </div>
                                 </div>
                                 ...
                                 <div id="histori" class="tab-pane fade">
                                     ...
                                     <table id="datahistori" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                 <thead>
                                     <tr>
                                         <th align='center'>
 ...
 <script src="<?= BASEURL; ?>/js/App/Tarif/TarifRajal/MasterTarif_Rajal_View.js"></script>