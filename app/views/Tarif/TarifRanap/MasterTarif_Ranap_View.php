                                ...
                                <div id="generalinfo" class="tab-pane fade in active">
                                    <div class="panel-body">
                                        <form class="form-horizontal" id="form_cuti">
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Kode Produk
                                                </label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for=" inputEmail3" class="col-sm-2 control-label"> Pacs Order
                                                    <sup class="color-danger">*</sup></label>
                                                <div class="col-sm-4">
                                                    <select class="form-control js-example-basic-single" id="PacsOrder"
                                                        name="PacsOrder">
                                                        <option value="">-- PILIH --</option>
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 control-label"> Paket <sup
                                                        class="color-danger">*</sup></label>
                                                <div class="col-sm-4">
...
<script src="<?= BASEURL; ?>/js/App/Tarif/TarifRanap/MasterTarif_Ranap_View.js"></script>