    ...
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                ...
                <p class="sub-title">Menampilkan Data List Master Tarif <?= $data['judul'] ?>.</p>
            </div>
            <!-- /.col-md-6 -->
        </div>
        <!-- /.row -->
...
<script src="<?= BASEURL; ?>/js/App/Tarif/TarifRadiologi/MasterTarif_Radiologi_List.js"></script>