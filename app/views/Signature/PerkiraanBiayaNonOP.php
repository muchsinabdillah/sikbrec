...
<div class="main-page"> 
    <section class="section">
                                    ...
                                    <div class="form-group gut">
                                            ...
                                            <div class="panel panel-success no-border">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group gut ">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="pasien_dpjp" name="pasien_dpjp" type="text"  placeholder="Ketik DPJP" value="<?= $data['register']['namadokter'] ?>">
                                                        </div> 
                                                    </div> 
                                                    <div class="form-group gut ">
                                        ...
                                        <div class="col-md-12 mt-25">
                                            <div class="panel panel-danger no-border">
                                                <div class="panel-heading">
                                                    <div class="panel-title">
                                                        <h5>PERKIRAAN BIAYA RUMAH SAKIT</h5>
                                                    </div>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Kamar Perawatan : @ Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_kamarperawatan" name="rs_kamarperawatan" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_kamarperawatan_ket" name="rs_kamarperawatan_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Kamar Intensive Care : @ Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_kamarintensive" name="rs_kamarintensive" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_kamarintensive_ket" name="rs_kamarintensive_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Laboratorium : ± Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_lab" name="rs_lab" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_lab_ket" name="rs_lab_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div>
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Radiologi : ± Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_radiologi" name="rs_radiologi" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_radiologi_ket" name="rs_radiologi_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Farmasi : ± Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_farmasi" name="rs_farmasi" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div>
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_farmasi_ket" name="rs_farmasi_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> BHP di perawatan: ± Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_bhp" name="rs_bhp" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_bhp_ket" name="rs_bhp_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                     <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Administrasi : ± Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_administrasi" name="rs_administrasi" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="rs_administrasi_ket" name="rs_administrasi_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                </div>
                                        ...
                                        <div class="col-md-12 mt-25">
                                            <div class="panel panel-danger no-border">
                                                <div class="panel-heading">
                                                    <div class="panel-title">
                                                        <h5>PERKIRAAN BIAYA JASA DOKTER</h5>
                                                    </div>
                                                </div>
                                                <div class="panel-body">
                                                <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Visite DPJP : @ Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visitedpjp" name="jd_visitedpjp" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visitedpjp_ket" name="jd_visitedpjp_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Visite di Intensive Care : @ Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visiteintensive" name="jd_visiteintensive" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div>
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visiteintensive_ket" name="jd_visiteintensive_ket" type="text" >
                                                        </div> 
                                                        </div>  
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Visite Konsul Anastesi : @ Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visitekonsulanestesi" name="jd_visitekonsulanestesi" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div>
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visitekonsulanestesi_ket" name="jd_visitekonsulanestesi_ket" type="text" >
                                                        </div> 
                                                        </div>  
                                                    </div> 
                                                    <div class="form-group"> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Visite Konsul Internis : @ Rp. </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visitekonsulinternis" name="jd_visitekonsulinternis" type="text" inputmode="numeric"  value="0">
                                                        </div> 
                                                        </div> 
                                                        <div class="col-sm-6">
                                                        <label for="inputEmail3" class="col-sm-4 control-label"> Keterangan : </label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm " id="jd_visitekonsulinternis_ket" name="jd_visitekonsulinternis_ket" type="text" >
                                                        </div> 
                                                        </div> 
                                                    </div> 
      ...
      <tbody> 
          ...
          <tr>
            <td align="left" width="30%"><font size="2">DPJP</td>
            <td align="left" width="70%"><font size="4"><label id="DPJPPasien_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">KAMAR PERAWATAN / KELAS</td>
    ...
    <br>
    <b>PERKIRAAN BIAYA:</b><br>
    <b>RUMAH SAKIT</b>
    <table width="100%" cellspacing="0" cellpadding="2" border="0" >
      <tbody> 
          <tr>
            <td align="left" width="30%"><font size="2">1. Kamar Perawatan</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="RSKamar_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="RSKamar_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">2. Kamar Intensive Care</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="KamarICU_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="KamarICU_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">3. Laboratorium</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="RSLab_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="RSLab_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">4. Radiologi</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="RSRad_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="RSRad_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">5. Farmasi</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="RSFarmasi_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="RSFarmasi_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">6. BHP di perawatan</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="RSBHP_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="RSBHP_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">7. Administrasi</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="RSAdm_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="RSAdm_ket_tmp"></label></font></td>
          </tr>
      </tbody>
    </table>
    ...
    <table width="100%" cellspacing="0" cellpadding="2" border="0" >
      <tbody> 
          <tr>
            <td align="left" width="30%"><font size="2">1. Visite DPJP</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="JDVisite_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="JDVisite_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">2. Visite di Intensive Care</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="JDVisiteICU_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4" align="left"><label id="JDVisiteICU_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">3. Visite Konsul Anestesi</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="JDVisiteKonsulAnestesi_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4"  align="left"><label id="JDVisiteKonsulAnestesi_ket_tmp"></label></font></td>
          </tr>

          <tr>
            <td align="left" width="30%"><font size="2">4. Visite Konsul Internis</td>
            <td align="left" width="20%"><font size="4" align="right"><label id="JDVisiteKonsulInternis_tmp"></label></font></td>
            <td align="left" width="50%"><font size="4"  align="left"><label id="JDVisiteKonsulInternis_ket_tmp"></label></font></td>
          </tr>
    ...
    <br>
    <p>Keterangan :</p>
    <p>1. Rincian Biaya perawatan tersebut bersifat fleksibel, dapat bertambah / berubah berdasarkan kondisi pasien saat perawatan.</p>
    <p>2. Biaya tersebut dapat berubah sewaktu-waktu tanpa adanya pemberitahuan terlebih dahulu.</p>
...
<script src="<?= BASEURL; ?>/js/App/SPR/PerkiraanBiayaiNonOP.js"></script>