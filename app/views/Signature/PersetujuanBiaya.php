                                ...
                                <div class="col-md-6 mt-25">
                                    ...
                                    <div class="col-md-6 mt-25">
                                        <div class="panel panel-success no-border">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Adalah benar yang menyetujui segala biaya tindakan atas pasien sebagai berikut :</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-4 control-label"> Rencana Tindakan :</label>
                                                    <div class="col-sm-8">
                                                        <input class="form-control input-sm " id="rencana_tindakan" name="rencana_tindakan" type="text">
                                                    </div> 
                                                </div>
                                                <div class="form-group gut">
                                                    <label for="inputEmail3" class="col-sm-4 control-label"> Estimasi Biaya :</label>
                                                    <div class="col-sm-8">
                                                        <input class="form-control input-sm " id="estimasi_biaya" name="estimasi_biaya" type="text" value='0' inputmode="numeric">
                                                    </div> 
                                                </div>
                                                <div class="form-group gut">
                                                ...
                                                <div class="form-group gut">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input class="form-control input-sm " id="ruangan" name="ruangan" type="text" >
                                                    </div> 
                                                </div>
                                        		...
                                        		<div id="collapse9One" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading9One">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="2" border="0" >
                                                        ...
                                                        <tbody> 
                                                            ...
                                                            <tr>
                                                                <td align="left" width="30%"><font size="2">Rencana Tindakan</td>
                                                                <td align="left" width="70%"><font size="4"><label id="RencanaTindakan_tmp"></label></font></td>
                                                            </tr>

                                                            <tr>
                                                                <td align="left" width="30%"><font size="2">Estimasi Biaya</td>
                                                                <td align="left" width="70%"><font size="4"><label id="EstimasiBiaya_tmp"></label></font></td>
                                                            </tr>

                                                            <tr>
                                                                <td align="left" width="30%"><font size="2">Kelas / Ruangan</td>
                                                                <td align="left" width="70%"><font size="4"><b><span id="Kelas_tmp"></span> / <span id="Ruangan_tmp"></span></font></b></td>
                                                            </tr>
...
<script src="<?= BASEURL; ?>/js/App/SPR/PersetujuanBiaya.js"></script>