...
<div class="main-page"> 
                ...
                <div class="panel border-primary no-border border-3-top"   >
                   <div class="panel-heading">
                      <div class="panel-title">
                         <h5>Masukan Kriteria Data yang anda inginkan</h5>
                      </div>
                   </div>
                   <div class="panel-body p-20">
                        ...
                        <form class="form-horizontal" id="frm_dashboard1"> 
                         <div class="form-group gut">
                            ...
                            <div class="col-sm-2">
                               <input type="month" class="form-control" id="Info_Date_Start" name="Info_Date_Start">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="panel border-primary no-border border-3-top data-panel-control">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Grafik Data Harian Pasien Baru/Lama</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body">
 ...
 <script src="<?= BASEURL; ?>/js/App/grafik/kunjungan/data.js?v=<?php echo time(); ?>"></script> 