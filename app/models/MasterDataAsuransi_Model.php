<?php
class MasterDataAsuransi_Model
{
    private $db;
    ...
    {
        try {
            $this->db->query("SELECT ID,NamaPerusahaan,Alamat,case when StatusAktif='1' then 'AKTIF' else 'TIDAK AKTIF' end as StatusAktif,Benefit 
    ...
    public function insert($data)
    {
        try {
            ...
            if ($data['IdAuto'] == "") {
                ...
                $this->db->query("INSERT INTO MasterdataSQL.dbo.MstrPerusahaanAsuransi (NamaPerusahaan,Alamat,Kota,Telephone,Fax,ContacPerson,TlpConcatP,
          Benefit,StatusAktif,RJ_Disc_Global,RJ_Disc_Administrasi,RJ_Disc_Laboratorium,RJ_Disc_Radiologi,RJ_Disc_Resep,RJ_Disc_JasaDokter,
        RJ_Disc_Sewaalat,RI_Disc_Global,RI_Disc_Administrasi,RI_Disc_Laboratorium,RI_Disc_Radiologi,RI_Disc_Resep,RI_Disc_JasaDokter,RI_Disc_Sewaalat,Special_benefit_Silver,Special_benefit_Gold,Special_benefit_Platinum,Special_benefit_Diamond,masaberlaku_awal,masaberlaku_akhir,Group_Jaminan,Alamat_Penagihan,Rekening,Gen_BP,IDFormularium) VALUES
                  (:NamaPerusahaan,:AlamatPerusahaan,:KotaPerusahaan,:TelponPerusahaan,:FaxPerusahaan,:CPPerusahaan,:TelpCPPerusahaan,:BenefitPerusahaan,:StatusPerusahaan,:rj_disc_global,:rj_disc_administrasi,:rj_disc_lab,:rj_disc_radiologi,:rj_disc_resep,:rj_disc_jasadokter,:rj_disc_sewaalat,:ri_disc_global,:ri_disc_administrasi,:ri_disc_lab,:ri_disc_radiologi,:ri_disc_resep,:ri_disc_jasadokter,:ri_disc_sewaalat,:special_benefit_silver,:special_benefit_gold,:special_benefit_platinum,:special_benefit_diamond,:MasaBerlakuAwal,:MasaBerlakuAkhir,:GruptarifPerusahaan,:AlamatPenagihan,:KodeRekening,:GenBP,:IDFormularium)");
                ...
                $this->db->query("UPDATE MasterdataSQL.dbo.MstrPerusahaanAsuransi set  
                                NamaPerusahaan=:NamaPerusahaan,Alamat=:AlamatPerusahaan,
                                Kota=:KotaPerusahaan,Telephone=:TelponPerusahaan,Fax=:FaxPerusahaan,ContacPerson=:CPPerusahaan,
                                TlpConcatP=:TelpCPPerusahaan,Benefit=:BenefitPerusahaan,StatusAktif=:StatusPerusahaan,
                                RJ_Disc_Global=:rj_disc_global,RJ_Disc_Administrasi=:rj_disc_administrasi,
                                RJ_Disc_Laboratorium=:rj_disc_lab,RJ_Disc_Radiologi=:rj_disc_radiologi,
                                ...
                                RI_Disc_Administrasi=:ri_disc_administrasi,RI_Disc_Laboratorium=:ri_disc_lab,
                                RI_Disc_Radiologi=:ri_disc_radiologi,RI_Disc_Resep=:ri_disc_resep,
                                RI_Disc_JasaDokter=:ri_disc_jasadokter,RI_Disc_Sewaalat=:ri_disc_sewaalat,
                                ...
                                Special_benefit_Diamond=:special_benefit_diamond,masaberlaku_awal=:MasaBerlakuAwal,
                                masaberlaku_akhir=:MasaBerlakuAkhir,Group_Jaminan=:GruptarifPerusahaan,
                                Alamat_Penagihan=:AlamatPenagihan,Rekening=:KodeRekening,Gen_BP=:GenBP,IDFormularium=:IDFormularium
                                WHERE ID=:IdAuto");
                $this->db->bind('NamaPerusahaan', $NamaPerusahaan);
                $this->db->bind('AlamatPerusahaan', $AlamatPerusahaan);
                $this->db->bind('KotaPerusahaan', $KotaPerusahaan);
    ...
    public function getAsuransiId($id)
    {
        try {
